...
class Stripey_OrderModel extends BaseElementModel
{
	const CART = 'cart';

	protected $elementType = 'Stripey_Order';
	protected $modelRecord = 'Stripey_OrderRecord';
	...
	public function getCpEditUrl()
	{
		...
		return UrlHelper::getCpUrl('stripey/orders/' . $orderType->handle . '/' . $this->id);
	}

	public function getOrderType()
	{
		return craft()->stripey_orderType->getById($this->typeId);
	}
