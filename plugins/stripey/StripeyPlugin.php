...
//        };
	...
	public function registerCpRoutes()
	{
		return array(
			...
			'stripey/settings/ordertypes'                                                              => array('action' => 'stripey/orderType/index'),
			'stripey/settings/ordertypes/(?P<orderTypeId>\d+)'                                         => array('action' => 'stripey/orderType/editorderType'),
			'stripey/settings/ordertypes/new'                                                          => array('action' => 'stripey/orderType/editOrderType'),
			...
			'stripey/orders'                                                                           => array('action' => 'stripey/order/orderIndex'),
			'stripey/orders/(?P<orderTypeHandle>{handle})/new'                                         => array('action' => 'stripey/order/editOrder'),
			'stripey/orders/(?P<orderTypeHandle>{handle})/(?P<orderId>\d+)'                            => array('action' => 'stripey/order/editOrder'),
