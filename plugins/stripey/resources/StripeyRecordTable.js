...
if (typeof Craft.Stripey == 'undefined')
{
    Craft.Stripey = {};
}

Craft.Stripey.EditableTable = Garnish.Base.extend(
    {
        id: null,
        baseName: null,
        columns: null,
        ...
        init: function(id, baseName, columns, settings)
        {
            ...
            this.setSettings(settings, Craft.Stripey.EditableTable.defaults);
        ...
        addRow: function()
        {
            var rowId = this.settings.rowIdPrefix+(this.biggestId+1),
                rowHtml = Craft.Stripey.EditableTable.getRowHtml(rowId, this.columns, this.baseName, {}),
        ...
        getRowHtml: function(rowId, columns, baseName, values)
        {
            ...
            for (var colId in columns)
            {
                var col = columns[colId],
                    ...
                    textual = Craft.inArray(col.type, Craft.Stripey.EditableTable.textualColTypes);
