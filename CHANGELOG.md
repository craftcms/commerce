...
- Added the `showCustomerInfoTab` setting to allow the control of showing the customer info tab on the User Edit page. ([#1037](https://github.com/craftcms/commerce/issues/1037))
