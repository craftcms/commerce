...
- Fixed a bug where variants' sort order weren’t being respected when reordering with disabled variants. ([#4270](https://github.com/craftcms/commerce/issues/4270))
