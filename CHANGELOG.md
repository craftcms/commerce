...
- Fixed a bug where the default variant wasn't updating in the element index until the data cache was cleared. ([#4294](https://github.com/craftcms/commerce/issues/4294))
