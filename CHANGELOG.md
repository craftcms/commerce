...
### Changed
- The order index page now updates the per-status order counts automatically after an using the “Update Order Status” action. ([#1217](https://github.com/craftcms/commerce/issues/1217))
