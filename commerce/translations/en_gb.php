...
return array(
	...
	'Flat' => 'Flat',
	'Flat value which should be added to each item in the order. Write negative number for off-discount' => 'Flat value which should be added to each item in the order. Write negative number for off-discount',
	'Flat value which should be added to the order total price. Write negative number for off-discount' => 'Flat value which should be added to the order total price. Write negative number for off-discount',
	...
	'Percentile value which should be added to the total order price. Write negative number for off-discount, i.e. -0,04 for 4% off' => 'Percentile value which should be added to the total order price. Write negative number for off-discount, i.e. -0,04 for 4% off',
	'Phone' => 'Phone',
