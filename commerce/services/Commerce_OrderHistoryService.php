...
/**
 * Class Commerce_OrderHistoryService
 *
 ...
 * @since     1.0
 */
class Commerce_OrderHistoryService extends BaseApplicationComponent
{
	/**
	 * @param int $id
	 *
	...
	public function createFromOrder (Commerce_OrderModel $order, $oldStatusId)
	{
		...
		$orderHistoryModel->customerId = craft()->commerce_customer->getCustomerId();
