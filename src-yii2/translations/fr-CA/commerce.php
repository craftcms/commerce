...
return [
    ...
    'Admin Notices' => 'Avis de l\'administrateur',
    ...
    'Automatic SKU Format' => 'Format automatique d\'UGS',
    ...
    'Available for purchase?' => 'Disponible à l’achat?',
    'Available inventory for "{description}" has gone below zero.' => 'Le stock disponible pour « {description} » est désormais inférieur à zéro.',
    ...
    'Cancel with gateway now' => 'Annuler avec la passerelle maintenant',
    'Cancel' => 'Annuler',
    ...
    'Card' => 'Carte',
    'Cart Recovery Link' => 'Lien de récupération du panier',
    ...
    'Choose a new customer' => 'Choisir un nouveau client',
    ...
    'Condition' => 'Condition',
    'Conditions here are matched against an order before looking through the rules. This is useful if you want to qualify a method’s availability early, or if there are common conditions to all rules for this method.' => 'Les conditions sont comparées à un ordre avant d\'examiner les règles. Cette fonction est utile si vous souhaitez vérifier la disponibilité d\'une méthode à un stade précoce ou s\'il existe des conditions communes à toutes les règles relatives à cette méthode.',
    'Conditions here are matched against the order’s customer before looking through the rules. This is useful if you want qualify a method’s availability early or if there are common conditions to all rules for this method.' => 'Les conditions sont comparées à la commande du client avant d\'examiner les règles. Cette fonction est utile si vous souhaitez vérifier la disponibilité d\'une méthode à un stade précoce ou s\'il existe des conditions communes à toutes les règles relatives à cette méthode.',
    'Conditions' => 'Conditions',
    'Contains Purchasables' => 'Contient des articles achetables',
    ...
    'Coupon can not apply discount to this order due to address mismatch.' => 'Le coupon ne peut pas être utilisé pour appliquer une remise à cette commande, car l\'adresse ne correspond pas.',
    'Coupon can not apply discount to this order due to customer mismatch.' => 'Le coupon ne peut pas être utilisé pour appliquer une remise à cette commande, car le client ne correspond pas.',
    'Coupon can not apply discount to this order.' => 'Le coupon ne peut pas être utilisé pour appliquer une remise à cette commande.',
    ...
    'Coupons' => 'Coupons',
    'Craft Commerce - Administration' => 'Craft Commerce - Administration',
    'Craft Commerce - Inventory' => 'Craft Commerce - Stocks',
    'Craft Commerce - Orders' => 'Craft Commerce - Commandes',
    'Craft Commerce - Product Type - {name}' => 'Craft Commerce - Type de produit - {name}',
    'Craft Commerce - Subscriptions' => 'Craft Commerce - Abonnements',
    ...
    'Create rules that allow this gateway to match the billing address.' => 'Créez des règles qui permettent à cette passerelle de faire correspondre l\'adresse de facturation.',
    'Create rules that allow this gateway to match the order.' => 'Créez des règles qui permettent à ce portail de correspondre à la commande.',
    'Create rules that allow this gateway to match the shipping address.' => 'Créez des règles qui permettent à cette passerelle de faire correspondre l\'adresse de livraison.',
    ...
    'Has Admin Notices' => 'Contient des avis de l\'administrateur',
    ...
    'Leave gateway subscription as-is' => 'Conserver l\'abonnement à la passerelle tel quel',
    ...
    'No new customer selected.' => 'Aucun nouveau client sélectionné.',
    ...
    'Order customer data removed.' => 'Données des clients supprimées des commandes.',
    ...
    'Product type settings' => 'Paramètres du type de produit',
    'Product' => 'Produit',
    ...
    'Quantity' => 'Quantité',
    'Rate' => 'Taux',
    'Reassign {numOrders, plural, =1{order} other{orders}}' => 'Réaffecter {numOrders, plural, =1{la commande} other{les commandes}}',
    ...
    'The cart recovery link is invalid. Please request a new one.' => 'Le lien de récupération du panier n\'est pas valide. Veuillez en demander un nouveau.',
    ...
    'The coupon "{code}" has exceeded its usage limit of {limit}.' => 'Le coupon « {code} » a dépassé la limite de {limit} utilisations.',
    'The customer for this order has been deleted.' => 'Le client associé à cette commande a été supprimé.',
    'The default shipping category is automatically available to all product types.' => 'La catégorie d\'expédition par défaut est automatiquement disponible pour tous les types de produits.',
    'The discount "{name}" has exceeded its total usage limit of {limit}.' => 'La remise « {name} » a dépassé sa limite d\'utilisation totale de {limit}.',
    'The download link has expired. Please request a new one.' => 'Le lien de téléchargement a expiré. Veuillez en demander un nouveau.',
    ...
    'The site the order was made in.' => 'Le site sur lequel la commande a été passée.',
    'The site to be used when this email is rendered.' => 'Le site à utiliser lorsque ce courriel est affiché.',
    ...
    'The unique SKU of the donation purchasable.' => 'L\'unique UGS de don pouvant être achetée.',
    ...
    'This category will be used as the default for all purchasables in this store.' => 'Cette catégorie sera utilisée par défaut pour tous les articles pouvant être achetés dans ce magasin.',
    ...
    'Unable to complete order: another request is already in progress.' => 'Impossible de terminer la commande : une autre demande est déjà en cours.',
    ...
    'Unable to reassign orders.' => 'Impossible de réattribuer les commandes.',
    'Unable to remove order data.' => 'Impossible de supprimer les données de la commande.',
    ...
    'What the unique auto-generated SKUs should look like, when a SKU field is submitted without a value. You can include tags that output properties, such as {ex1} or {ex2}' => 'Ce à quoi les UGS auto-générés devraient ressembler, lorsqu’un champ d\'UGS est soumis à vide. Vous pouvez inclure des étiquettes qui sélectionnent les propriétés, comme {ex1} ou {ex2}.',
    ...
    '{numOrders, number} {numOrders, plural, =1{order is} other{orders are}} associated with the {numUsers, plural, =1{user} other{users}}.' => '{numOrders, number} {numOrders, plural, =1{commande est associée} other{commandes sont associées}} {numUsers, plural, =1{à l\'utilisateur} other{aux utilisateurs}}.',
    '{numSubscriptions, number} {numSubscriptions, plural, =1{subscription is} other{subscriptions are}} activated for the {numUsers, plural, =1{user} other{users}}.' => '{numSubscriptions, number} {numSubscriptions, plural, =1{abonnement est activé} other{abonnements sont activés}} pour {numUsers, plural, =1{l\'utilisateur} other{les utilisateurs}}.',
