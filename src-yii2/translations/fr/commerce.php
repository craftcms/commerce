...
return [
    ...
    'Contains Purchasables' => 'Contient des articles disponibles à l\'achat',
    ...
    'Leave gateway subscription as-is' => 'Laisser l\'abonnement au portail tel quel',
    ...
    'The discount "{name}" has exceeded its total usage limit of {limit}.' => 'La réduction « {name} » a dépassé la limite de {limit} utilisations au total.',
    ...
    'Unable to remove order data.' => 'Impossible de supprimer les données de commande.',
    ...
    'You do not have permission to load this cart.' => 'Vous n\'avez pas l\'autorisation de charger ce panier.',
    ...
    'Your Cart Recovery Link' => 'Lien de récupération de votre panier',
