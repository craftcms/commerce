...
return [
    ...
    'A cart recovery link will be sent to {email}.' => 'En lenke for gjenoppretting av handlekurv blir sendt til {email}.',
    ...
    'All variants must have a SKU.' => 'Alle varianter må ha en SKU.',
    'All' => 'Alle',
    ...
    'Available for purchase?' => 'Tilgjengelig for kjøp?',
    'Available inventory for "{description}" has gone below zero.' => 'Tilgjengelig inventar for «{description}» har gått under null.',
    ...
    'Cancel with gateway now' => 'Avbryt med gateway nå',
    'Cancel' => 'Kansellere',
    ...
    'Card' => 'Kort',
    'Cart Recovery Link' => 'Lenke for gjenoppretting av handlekurv',
    ...
    'Choose a new customer' => 'Velg en ny kunde',
    ...
    'Conditions here are matched against the order’s customer before looking through the rules. This is useful if you want qualify a method’s availability early or if there are common conditions to all rules for this method.' => 'Her matches betingelsene mot ordrens kunde før reglene blir vurdert. Dette er nyttig hvis du ønsker å kvalifisere en metodes tilgjengelighet tidlig, eller hvis det finnes felles betingelser for alle reglene for denne metoden.',
    'Conditions' => 'Betingelser',
    'Contains Purchasables' => 'Inneholder kjøpbare varer',
    ...
    'Coupon can not apply discount to this order due to address mismatch.' => 'Kupongen kan ikke brukes til å gi rabatt på denne ordren på grunn av adresseavvik.',
    'Coupon can not apply discount to this order due to customer mismatch.' => 'Kupongen kan ikke brukes til å gi rabatt på denne ordren på grunn av kundeavvik.',
    'Coupon can not apply discount to this order.' => 'Kupongen kan ikke brukes til å gi rabatt på denne ordren.',
    ...
    'Coupons' => 'Kuponger',
    'Craft Commerce - Administration' => 'Craft Commerce – Administrasjon',
    'Craft Commerce - Inventory' => 'Craft Commerce – Inventar',
    'Craft Commerce - Orders' => 'Craft Commerce – Ordrer',
    'Craft Commerce - Product Type - {name}' => 'Craft Commerce – Produkttype – {name}',
    'Craft Commerce - Subscriptions' => 'Craft Commerce – Abonnementer',
    ...
    'Create rules that allow this gateway to match the billing address.' => 'Opprett regler som lar denne portalen matche faktureringsadressen.',
    'Create rules that allow this gateway to match the order.' => 'Opprett regler som lar denne portalen matche ordren.',
    'Create rules that allow this gateway to match the shipping address.' => 'Opprett regler som lar denne portalen matche faktureringsadressen.',
    ...
    'Date First Paid' => 'Første betalingsdato',
    ...
    'Has Admin Notices' => 'Har administratorvarsler',
    ...
    'How products should be labeled within the control panel.' => 'Slik skal oppføringer merkes i kontrollpanelet.',
    ...
    'How variants should be labeled within the control panel.' => 'Slik skal varianter merkes i kontrollpanelet.',
    ...
    'Leave gateway subscription as-is' => 'La gateway-abonnementet være uendret',
    ...
    'Live' => 'Direkte',
    'Location' => 'Sted',
    'Locations that should be available for previewing products in this product type.' => 'Plasseringer som bør være tilgjengelig for forhåndsvisning av produkter av denne produkttypen.',
    'MM' => 'MM',
    ...
    'No new customer selected.' => 'Ingen ny kunde valgt.',
    ...
    'Order customer data removed.' => 'Kundedata bestilt fjernet.',
    ...
    'Product type settings' => 'Innstillinger for produkttype',
    'Product' => 'Produkt',
    ...
    'Quantity' => 'Kvantitet',
    'Rate' => 'Pris',
    'Reassign {numOrders, plural, =1{order} other{orders}}' => 'Tildel {numOrders, plural, =1{ordre} other{ordrer}}',
    ...
    'Recipient' => 'Mottaker',
    'Recover Cart' => 'Gjenopprett handlekurv',
    ...
    'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below' => 'Fjern kundetilknytning og e-post fra {numOrders, plural, =1{ordre} other{ordrer}}. Valgfritt: velg ytterligere kundedata som skal fjernes nedenfor',
    'Remove customer data' => 'Fjern kundedata',
    ...
    'The cart recovery link is invalid. Please request a new one.' => 'Lenken for gjenoppretting av handlekurv er ugyldig. Be om en ny.',
    ...
    'The coupon "{code}" has exceeded its usage limit of {limit}.' => 'Kupongen «{code}» har overskredet bruksgrensen på {limit}.',
    'The customer for this order has been deleted.' => 'Kunden for denne ordren ble slettet.',
    'The default shipping category is automatically available to all product types.' => 'Standard fraktkategori er automatisk tilgjengelig for alle produkttyper.',
    'The discount "{name}" has exceeded its total usage limit of {limit}.' => 'Rabatten «{name}» har overskredet bruksgrensen på {limit}.',
    'The download link has expired. Please request a new one.' => 'Nedlastingslenken er utløpt. Be om en ny.',
    ...
    'The site the order was made in.' => 'Nettstedet som ordren ble laget på.',
    'The site to be used when this email is rendered.' => 'Nettstedet som skal brukes i e-posten som genereres.',
    ...
    'This category will be used as the default for all purchasables in this store.' => 'Denne kategorien vil bli brukt som standard for alle varer som kan kjøpes i denne butikken.',
    ...
    'Unable to complete order: another request is already in progress.' => 'Kunne ikke fullføre ordren: En annen forespørsel er allerede i gang.',
    ...
    'Unable to reassign orders.' => 'Kunne ikke tilordne ordrer på nytt.',
    'Unable to remove order data.' => 'Kunne ikke fjerne ordredata.',
    ...
    'Variant UI Label Format' => 'Etikettformat for grensesnitt for variant',
    ...
    'You do not have permission to load this cart.' => 'Du har ikke tillatelse til å laste inn denne handlekurven.',
    ...
    'You must be logged in or provide a valid token to load this cart.' => 'Du må være innlogget eller oppgi en gyldig nøkkel for å laste inn denne handlekurven.',
    ...
    'Your Cart Recovery Link' => 'Lenken din for gjenoppretting av handlekurv',
    ...
    '{numOrders, number} {numOrders, plural, =1{order is} other{orders are}} associated with the {numUsers, plural, =1{user} other{users}}.' => '{numOrders, number} {numOrders, plural, =1{ordre er} other{ordrer er}} assosiert med {numUsers, plural, =1{bruker} other{brukere}}.',
    '{numSubscriptions, number} {numSubscriptions, plural, =1{subscription is} other{subscriptions are}} activated for the {numUsers, plural, =1{user} other{users}}.' => '{numSubscriptions, number} {numSubscriptions, plural, =1{abonnement er} other{abonnementer er}} aktivert for {numUsers, plural, =1{bruker} other{brukere}}.',
