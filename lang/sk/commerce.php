...
return [
    ...
    'Address copied to user.' => 'Adresa skopírovaná pre používateľa.',
    'Address not found.' => 'Adresa nebola nájdená.',
    'Adjust Quantity' => 'Upraviť množstvo',
    'Adjust by' => 'Upraviť podľa',
    ...
    'Admin Notices' => 'Oznámenia správcu',
    ...
    'All variants must have a SKU.' => 'Všetky varianty musia mať SKU.',
    'All' => 'Všetky',
    ...
    'Available for purchase?' => 'Dostupné na nákup?',
    'Available inventory for "{description}" has gone below zero.' => 'Dostupné zásoby pre položky „{description}“ klesli pod nulu.',
    ...
    'Cancel with gateway now' => 'Zrušiť cez platobnú bránu teraz',
    'Cancel' => 'Zrušiť',
    ...
    'Card' => 'Karta',
    'Cart Recovery Link' => 'Odkaz na obnovenie košíka',
    ...
    'Choose a new customer' => 'Vyberte nového zákazníka',
    ...
    'Conditions here are matched against the order’s customer before looking through the rules. This is useful if you want qualify a method’s availability early or if there are common conditions to all rules for this method.' => 'Podmienky sa tu porovnávajú so zákazníkom objednávky pred vyhľadaním pravidiel. To je užitočné, ak chcete predčasne overiť dostupnosť metódy alebo ak existujú spoločné podmienky pre všetky pravidlá pre túto metódu.',
    'Conditions' => 'Podmienky',
    'Contains Purchasables' => 'Obsahuje položky na predaj',
    ...
    'Coupon can not apply discount to this order due to address mismatch.' => 'Kupón nie je možné uplatniť na túto objednávku z dôvodu nesúladu adries.',
    'Coupon can not apply discount to this order due to customer mismatch.' => 'Kupón nie je možné uplatniť na túto objednávku z dôvodu nesúladu zákazníka.',
    'Coupon can not apply discount to this order.' => 'Kupón nie je možné uplatniť na túto objednávku.',
    ...
    'Coupons' => 'Kupóny',
    'Craft Commerce - Administration' => 'Craft Commerce – Správa',
    'Craft Commerce - Inventory' => 'Craft Commerce – Zásoby',
    'Craft Commerce - Orders' => 'Craft Commerce – Objednávky',
    'Craft Commerce - Product Type - {name}' => 'Craft Commerce – Typ výrobku – {name}',
    'Craft Commerce - Subscriptions' => 'Craft Commerce – Predplatné',
    ...
    'Create rules that allow this gateway to match the billing address.' => 'Vytvorte pravidlá, ktoré umožnia, aby táto brána zodpovedala fakturačnej adrese.',
    'Create rules that allow this gateway to match the order.' => 'Vytvorte pravidlá, ktoré umožnia, aby táto platobná brána zodpovedala objednávke.',
    'Create rules that allow this gateway to match the shipping address.' => 'Vytvorte pravidlá, ktoré umožnia, aby táto brána zodpovedala dodacej adrese.',
    ...
    'Customer data' => 'Údaje o zákazníkoch',
    'Customer' => 'Zákazník',
    'Damaged' => 'Poškodené',
    ...
    'Date First Paid' => 'Dátum prvej platby',
    ...
    'Has Admin Notices' => 'Obsahuje oznámenia správcu',
    ...
    'How products should be labeled within the control panel.' => 'Ako by mali byť produkty označené v ovládacom paneli.',
    ...
    'How variants should be labeled within the control panel.' => 'Ako by mali byť varianty označené v ovládacom paneli.',
    ...
    'Leave gateway subscription as-is' => 'Pnoechať predplatné brány bez zmien',
    ...
    'Live' => 'Publikované',
    'Location' => 'Poloha',
    'Locations that should be available for previewing products in this product type.' => 'Umiestnenia, ktoré majú byť dostupné pre náhľad produktov v tomto type produktu.',
    'MM' => 'MM',
    ...
    'No new customer selected.' => 'Nebol vybraný žiadny nový zákazník.',
    ...
    'Order customer data removed.' => 'Nariadiť odstránenie údajov o zákazníkoch.',
    ...
    'Product type settings' => 'Nastavenia typu produktu',
    'Product' => 'Produkt',
    ...
    'Quantity' => 'Množstvo',
    'Rate' => 'Sadzba',
    'Reassign {numOrders, plural, =1{order} other{orders}}' => 'Znovu prideliť {numOrders, plural, one {} few {objednávky} many {objednávok}=1{objednávku} other{objednávok}}',
    ...
    'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below' => 'Odstrániť prepojenie so zákazníkom a e-mailovú adresu z {numOrders, plural, one {} few {objednávok} many {objednávok}=1{objednávky} other{objednávok}}. Podľa potreby nižšie vyberte ďalšie údaje o zákazníkoch, ktoré chcete odstrániť',
    'Remove customer data' => 'Odstrániť údaje o zákazníkoch',
    ...
    'The cart recovery link is invalid. Please request a new one.' => 'Odkaz na obnovenie košíka je neplatný. Požiadajte o nový.',
    ...
    'The coupon "{code}" has exceeded its usage limit of {limit}.' => 'Kupón „{code}“ prekročil limit použitia {limit}.',
    'The customer for this order has been deleted.' => 'Zákazník, na ktorého sa táto objednávka vzťahuje, bol odstránený.',
    'The default shipping category is automatically available to all product types.' => 'Predvolená kategória dopravy je automaticky dostupná pre všetky typy produktov.',
    'The discount "{name}" has exceeded its total usage limit of {limit}.' => 'Zľava „{name}“ prekročila limit použitia {limit}.',
    'The download link has expired. Please request a new one.' => 'Platnosť odkazu na stiahnutie vypršala. Požiadajte o nový odkaz.',
    ...
    'The site the order was made in.' => 'Miesto, kde bola objednávka zadaná.',
    'The site to be used when this email is rendered.' => 'Miesto, ktoré sa má použiť pri zobrazení tohto e-mailu.',
    ...
    'This category will be used as the default for all purchasables in this store.' => 'Táto kategória sa bude používať ako predvolená pre všetky nákupy v tomto obchode.',
    ...
    'Unable to complete order: another request is already in progress.' => 'Objednávku nie je možné dokončiť: práve prebieha iná požiadavka.',
    ...
    'Unable to reassign orders.' => 'Objednávky nie je možné prerozdeliť.',
    'Unable to remove order data.' => 'Údaje o objednávke sa nepodarilo odstrániť.',
    ...
    'Variant UI Label Format' => 'Formát označenia variantu používateľského rozhrania',
    ...
    'You do not have permission to load this cart.' => 'Nemáte oprávnenie na načítanie tohto košíka.',
    ...
    'You must be logged in or provide a valid token to load this cart.' => 'Na načítanie tohto košíka sa musíte prihlásiť alebo zadať platný token.',
    ...
    'Your Cart Recovery Link' => 'Váš odkaz na obnovenie košíka',
    ...
    '{numOrders, number} {numOrders, plural, =1{order is} other{orders are}} associated with the {numUsers, plural, =1{user} other{users}}.' => '{numOrders, number} {numOrders, plural, one {} few {objednávky sú priradené} many {objednávok je priradených}=1{objednávka je priradená} other{objednávok je priradených}} k {numUsers, plural, one {} few {používateľom} many {používateľom}=1{používateľovi} other{používateľom}}.',
