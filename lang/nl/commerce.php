...
return [
    ...
    'Admin Notices' => 'Beheerderskennisgevingen',
    ...
    'Available for purchase?' => 'Beschikbaar voor aankoop?',
    'Available inventory for "{description}" has gone below zero.' => 'De beschikbare voorraad voor "{description}" is lager dan nul.',
    ...
    'Cancel with gateway now' => 'Nu annuleren met gateway',
    'Cancel' => 'Annuleer',
    ...
    'Choose a new customer' => 'Kies een nieuwe klant',
    ...
    'Contains Purchasables' => 'Bevat koopbare artikelen',
    ...
    'Coupons' => 'Coupons',
    'Craft Commerce - Administration' => 'Craft Commerce - Administratie',
    'Craft Commerce - Inventory' => 'Craft Commerce - Voorraad',
    'Craft Commerce - Orders' => 'Craft Commerce - Bestellingen',
    'Craft Commerce - Product Type - {name}' => 'Craft Commerce - Producttype - {name}',
    'Craft Commerce - Subscriptions' => 'Craft Commerce - Abonnementen',
    ...
    'Create rules that allow this gateway to match the billing address.' => 'Maak regels waardoor deze gateway bij het factuuradres past.',
    'Create rules that allow this gateway to match the order.' => 'Maak regels waardoor deze gateway overeenkomt met de bestelling.',
    'Create rules that allow this gateway to match the shipping address.' => 'Maak regels waardoor deze gateway bij het verzendadres past.',
    ...
    'Leave gateway subscription as-is' => 'Gatewayabonnement ongewijzigd laten',
    ...
    'No new customer selected.' => 'Geen nieuwe klant geselecteerd.',
    ...
    'Rate' => 'Score',
    'Reassign {numOrders, plural, =1{order} other{orders}}' => '{numOrders, plural, one {}=1{bestelling} other{bestellingen}} opnieuw toewijzen',
    ...
    'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below' => 'Verwijder klantassociatie en e-mailadres uit de {numOrders, plural, one {}=1{bestelling} other{bestellingen}}. Selecteer optioneel extra klantgegevens hieronder om te verwijderen',
    'Remove customer data' => 'Klantgegevens verwijderen',
    ...
    'The coupon "{code}" has exceeded its usage limit of {limit}.' => 'De gebruikslimiet van {limit} van de coupon "{code}" is overschreden.',
    'The customer for this order has been deleted.' => 'De klant voor deze bestelling is verwijderd.',
    ...
    'The discount "{name}" has exceeded its total usage limit of {limit}.' => 'De gebruikslimiet van {limit} van de korting "{name}" is overschreden.',
    'The download link has expired. Please request a new one.' => 'De downloadlink is verlopen. Vraag een nieuwe aan.',
    ...
    'Unable to complete order: another request is already in progress.' => 'Kan bestelling niet voltooien: er loopt al een andere aanvraag.',
    ...
    'Unable to reassign orders.' => 'Kan bestellingen niet opnieuw toewijzen.',
    'Unable to remove order data.' => 'Kan bestelgegevens niet verwijderen.',
    ...
    '{numOrders, number} {numOrders, plural, =1{order is} other{orders are}} associated with the {numUsers, plural, =1{user} other{users}}.' => '{numOrders, number} {numOrders, plural, one {}=1{bestelling is} other{bestellingen zijn}} geassocieerd met de {numUsers, plural, one {}=1{gebruiker} other{gebruikers}}.',
