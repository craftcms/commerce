...
return [
    ...
    'A cart recovery link has been sent to {email}.' => 'Un link per il recupero del carrello è stato inviato all\'indirizzo {email}.',
    'A cart recovery link will be sent to {email}.' => 'Un link per il recupero del carrello sarà inviato all\'indirizzo {email}.',
    ...
    'Admin Notices' => 'Avvisi dell\'amministratore',
    ...
    'All variants must have a SKU.' => 'Tutte le varianti devono avere uno SKU.',
    'All' => 'Tutti',
    ...
    'Available for purchase?' => 'Disponibile all’acquisto?',
    'Available inventory for "{description}" has gone below zero.' => 'Le scorte disponibili per “{description}” sono pari a zero.',
    ...
    'Cancel with gateway now' => 'Annulla ora tramite gateway',
    'Cancel' => 'Annulla',
    ...
    'Card' => 'Carta',
    'Cart Recovery Link' => 'Link per il recupero del carrello',
    ...
    'Choose a new customer' => 'Scegli un nuovo cliente',
    ...
    'Conditions here are matched against the order’s customer before looking through the rules. This is useful if you want qualify a method’s availability early or if there are common conditions to all rules for this method.' => 'Le condizioni vengono confrontate con il cliente dell\'ordine prima di esaminare le regole. Ciò è utile se si desidera qualificare in anticipo la disponibilità di un metodo o se esistono condizioni comuni per tutte le regole per questo metodo.',
    'Conditions' => 'Condizioni',
    'Contains Purchasables' => 'Contiene prodotti disponibili all’acquisto',
    ...
    'Coupon can not apply discount to this order due to address mismatch.' => 'Impossibile applicare lo sconto a questo ordine tramite il codice promozionale a causa della mancata corrispondenza dell\'indirizzo.',
    'Coupon can not apply discount to this order due to customer mismatch.' => 'Impossibile applicare lo sconto a questo ordine tramite il codice promozionale a causa della mancata corrispondenza del cliente.',
    'Coupon can not apply discount to this order.' => 'Impossibile applicare lo sconto a questo ordine tramite il codice promozionale.',
    ...
    'Craft Commerce - Administration' => 'Craft Commerce - Amministrazione',
    'Craft Commerce - Inventory' => 'Craft Commerce - Inventario',
    'Craft Commerce - Orders' => 'Craft Commerce - Ordini',
    'Craft Commerce - Product Type - {name}' => 'Craft Commerce - Tipo di prodotto - {name}',
    'Craft Commerce - Subscriptions' => 'Craft Commerce - Abbonamenti',
    ...
    'Create rules that allow this gateway to match the billing address.' => 'Crea delle regole che consentano a questo gateway di corrispondere all\'indirizzo di fatturazione.',
    'Create rules that allow this gateway to match the order.' => 'Crea regole che permettono a questo gateway di corrispondere all\'ordine.',
    'Create rules that allow this gateway to match the shipping address.' => 'Crea delle regole che consentano a questo gateway di corrispondere all\'indirizzo di spedizione.',
    ...
    'Customer data' => 'Dati dei clienti',
    'Customer' => 'Cliente',
    'Damaged' => 'Danneggiato',
    ...
    'Date First Paid' => 'Data primo pagamento',
    ...
    'Has Admin Notices' => 'Contiene avvisi dell\'amministratore',
    ...
    'How products should be labeled within the control panel.' => 'Come devono essere etichettati i prodotti nel pannello di controllo.',
    ...
    'How variants should be labeled within the control panel.' => 'Come devono essere etichettate le varianti nel pannello di controllo.',
    ...
    'Leave gateway subscription as-is' => 'Lascia invariato l\'abbonamento al gateway',
    ...
    'Live' => 'Pubblicato',
    'Location' => 'Sede',
    'Locations that should be available for previewing products in this product type.' => 'Posizioni che dovrebbero essere disponibili per l\'anteprima dei prodotti in questo tipo di prodotto.',
    'MM' => 'MM',
    ...
    'No new customer selected.' => 'Non è stato selezionato alcun nuovo cliente.',
    ...
    'Product type settings' => 'Impostazioni tipo di prodotto',
    'Product' => 'Prodotto',
    ...
    'Quantity' => 'Quantità',
    'Rate' => 'Tasso',
    'Reassign {numOrders, plural, =1{order} other{orders}}' => 'Riassegna {numOrders, plural, one {}=1{ordine} other{ordini}}',
    ...
    'Recover Cart' => 'Recupera carrello',
    ...
    'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below' => 'Rimuovi l\'associazione al cliente e l\'indirizzo e-mail da {numOrders, plural, one {}=1{ordine} other{ordini}}. Puoi scegliere di selezionare ulteriori dati del cliente da rimuovere qui sotto',
    'Remove customer data' => 'Rimuovi dati dei clienti',
    ...
    'The cart recovery link is invalid. Please request a new one.' => 'Il link per il recupero del carrello non è valido. Richiedine uno nuovo.',
    ...
    'The coupon "{code}" has exceeded its usage limit of {limit}.' => 'Il coupon “{code}” ha superato il limite di utilizzo di {limit}.',
    'The customer for this order has been deleted.' => 'Il cliente associato a questo ordine è stato eliminato.',
    'The default shipping category is automatically available to all product types.' => 'La categoria di spedizione predefinita è automaticamente disponibile per tutti i tipi di prodotto.',
    'The discount "{name}" has exceeded its total usage limit of {limit}.' => 'Lo sconto “{name}” ha superato il limite totale di utilizzo di {limit}.',
    'The download link has expired. Please request a new one.' => 'Il link di download è scaduto. Richiedine uno nuovo.',
    ...
    'The site the order was made in.' => 'Il sito in cui è stato effettuato l\'ordine.',
    'The site to be used when this email is rendered.' => 'Il sito da utilizzare quando viene visualizzata questa email.',
    ...
    'This category will be used as the default for all purchasables in this store.' => 'Questa categoria verrà utilizzata come predefinita per tutti gli articoli disponibili all’acquisto in questo store.',
    ...
    'Unable to complete order: another request is already in progress.' => 'Impossibile completare l\'ordine: è già in corso un\'altra richiesta.',
    ...
    'Unable to reassign orders.' => 'Impossibile riassegnare gli ordini.',
    'Unable to remove order data.' => 'Impossibile eliminare i dati dell\'ordine.',
    ...
    'Variant UI Label Format' => 'Formato etichetta UI variante',
    ...
    'You do not have permission to load this cart.' => 'Non disponi delle autorizzazioni necessarie per caricare questo carrello.',
    ...
    'You must be logged in or provide a valid token to load this cart.' => 'Per caricare questo carrello è necessario effettuare l’accesso o presentare un token valido.',
    ...
    'Your Cart Recovery Link' => 'Il tuo link per il recupero del carrello',
    ...
    '{numOrders, number} {numOrders, plural, =1{order is} other{orders are}} associated with the {numUsers, plural, =1{user} other{users}}.' => '{numOrders, number} {numOrders, plural, one {}=1{ordine è} other{ordini sono}} associato/i {numUsers, plural, one {}=1{all\'utente} other{agli utenti}}.',
    '{numSubscriptions, number} {numSubscriptions, plural, =1{subscription is} other{subscriptions are}} activated for the {numUsers, plural, =1{user} other{users}}.' => '{numSubscriptions, number} {numSubscriptions, plural, one {}=1{abbonamento è} other{abbonamenti sono}} attivato/i per {numUsers, plural, one {}=1{l\'utente} other{gli utenti}}.',
