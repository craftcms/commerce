...
return [
    ...
    'A cart recovery link has been sent to {email}.' => 'Ein neuer Warenkorb-Wiederherstellungslink wurde an {email} gesendet.',
    'A cart recovery link will be sent to {email}.' => 'Ein Warenkorb-Wiederherstellungslink wird an {email} gesendet.',
    ...
    'Admin Notices' => 'Administratorhinweise',
    ...
    'Available for purchase?' => 'Für den Kauf verfügbar?',
    'Available inventory for "{description}" has gone below zero.' => 'Der verfügbare Lagerbestand für „{description}“ ist unter null gesunken.',
    ...
    'Cancel with gateway now' => 'Jetzt über das Zahlungsportal stornieren',
    'Cancel' => 'Abbrechen',
    ...
    'Card' => 'Karte',
    'Cart Recovery Link' => 'Warenkorb-Wiederherstellungslink',
    ...
    'Choose a new customer' => 'Neuen Kunden wählen',
    ...
    'Conditions here are matched against the order’s customer before looking through the rules. This is useful if you want qualify a method’s availability early or if there are common conditions to all rules for this method.' => 'Die Bedingungen werden hier mit denen des Kunden abgeglichen, bevor die Regeln abgesucht werden. Dies ist nützlich, wenn Sie die Verfügbarkeit einer Methode frühzeitig prüfen möchten oder wenn es gemeinsame Bedingungen für alle Regeln für diese Methode gibt.',
    'Conditions' => 'Bedingungen',
    'Contains Purchasables' => 'Enthält kaufbare Artikel',
    ...
    'Coupon can not apply discount to this order due to address mismatch.' => 'Der Coupon kann aufgrund einer Adressabweichung keinen Rabatt auf diese Bestellung anwenden.',
    'Coupon can not apply discount to this order due to customer mismatch.' => 'Der Coupon kann aufgrund einer Unstimmigkeit seitens des Kunden keinen Rabatt auf diese Bestellung gewähren.',
    'Coupon can not apply discount to this order.' => 'Der Coupon kann keinen Rabatt auf diese Bestellung anwenden.',
    ...
    'Craft Commerce - Inventory' => 'Craft Commerce - Lagerbestand',
    'Craft Commerce - Orders' => 'Craft Commerce - Bestellungen',
    'Craft Commerce - Product Type - {name}' => 'Craft Commerce - Produkttyp - {name}',
    ...
    'Create rules that allow this gateway to match the billing address.' => 'Erstellen Sie Regeln, die es diesem Gateway ermöglichen, die Rechnungsadresse zuzuordnen.',
    'Create rules that allow this gateway to match the order.' => 'Erstellen Sie Regeln, die es diesem Gateway ermöglichen, die Bestellung zuzuordnen.',
    'Create rules that allow this gateway to match the shipping address.' => 'Erstellen Sie Regeln, die es diesem Gateway ermöglichen, die Versandadresse zuzuordnen.',
    ...
    'Date First Paid' => 'Erstes Zahlungsdatum',
    ...
    'Has Admin Notices' => 'Enthält Administratorhinweise',
    ...
    'Leave gateway subscription as-is' => 'Gateway-Abonnement unverändert lassen',
    ...
    'No new customer selected.' => 'Es wurde kein neuer Kunde ausgewählt.',
    ...
    'Order customer data removed.' => 'Kundenbestelldaten gelöscht.',
    ...
    'Product type settings' => 'Produkttyp-Einstellungen',
    'Product' => 'Produkt',
    ...
    'Quantity' => 'Menge',
    'Rate' => 'Satz',
    'Reassign {numOrders, plural, =1{order} other{orders}}' => '{numOrders, plural, one {}=1{Bestellung} other{Bestellungen}} neu zuweisen',
    ...
    'Recipient' => 'Empfänger',
    'Recover Cart' => 'Warenkorb wiederherstellen',
    ...
    'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below' => 'Entfernen Sie die Kundenzuordnung und die E-Mail-Adresse aus {numOrders, plural, one {}=1{der Bestellung} other{den Bestellungen}}. Wählen Sie gegebenenfalls unten weitere Kundendaten aus, die Sie entfernen möchten',
    'Remove customer data' => 'Kundendaten entfernen',
    ...
    'The cart recovery link is invalid. Please request a new one.' => 'Der Warenkorb-Wiederherstellungslink ist ungültig. Bitte fordern Sie einen neuen an.',
    ...
    'The coupon "{code}" has exceeded its usage limit of {limit}.' => 'Der Coupon „{code}“ hat sein Nutzungslimit von {limit} überschritten.',
    'The customer for this order has been deleted.' => 'Der Kunde für diese Bestellung wurde gelöscht.',
    'The default shipping category is automatically available to all product types.' => 'Die Standardversandkategorie ist automatisch für alle Produkttypen verfügbar.',
    'The discount "{name}" has exceeded its total usage limit of {limit}.' => 'Der Rabatt „{name}“ hat sein Gesamtnutzungslimit von {limit} überschritten.',
    'The download link has expired. Please request a new one.' => 'Der Download-Link ist abgelaufen. Bitte fordern Sie einen neuen an.',
...
Prozentwerte sind auf zwei Dezimalstellen gerundet.',
    ...
    'The site the order was made in.' => 'Die Website, von der aus die Bestellung aufgegeben wurde.',
    'The site to be used when this email is rendered.' => 'Die Website, die verwendet werden soll, wenn diese E-Mail wiedergegeben wird.',
    ...
    'This category will be used as the default for all purchasables in this store.' => 'Diese Kategorie wird als Standard für alle in diesem Shop erhältlichen Artikel verwendet.',
    ...
    'Unable to complete order: another request is already in progress.' => 'Die Bestellung kann nicht abgeschlossen werden: Eine andere Anfrage wird bereits bearbeitet.',
    ...
    'Unable to reassign orders.' => 'Bestellungen können nicht neu zugewiesen werden.',
    'Unable to remove order data.' => 'Die Bestelldaten konnten nicht gelöscht werden.',
    ...
    'You do not have permission to load this cart.' => 'Sie haben keine Berechtigung, diesen Warenkorb zu laden.',
    ...
    'You must be logged in or provide a valid token to load this cart.' => 'Sie müssen angemeldet sein oder ein gültiges Token bereitstellen, um diesen Warenkorb zu laden.',
    ...
    'Your Cart Recovery Link' => 'Ihr Warenkorb-Wiederherstellungslink',
    ...
    '{numOrders, number} {numOrders, plural, =1{order is} other{orders are}} associated with the {numUsers, plural, =1{user} other{users}}.' => '{numOrders, number} {numOrders, plural, one {}=1{Bestellung ist} other{Bestellungen sind}} mit {numUsers, plural, one {}=1{dem Nutzer} other{den Nutzern}} verknüpft.',
    '{numSubscriptions, number} {numSubscriptions, plural, =1{subscription is} other{subscriptions are}} activated for the {numUsers, plural, =1{user} other{users}}.' => '{numSubscriptions, number} {numSubscriptions, plural, one {}=1{Abonnement ist} other{Abonnements sind}} für {numUsers, plural, one {}=1{den Nutzer} other{die Nutzer}} aktiviert.',
