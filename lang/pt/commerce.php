...
return [
    ...
    'A cart recovery link will be sent to {email}.' => 'Será enviado um link para recuperar o carrinho para {email}.',
    ...
    'Address copied to user.' => 'Endereço copiado para o utilizador.',
    ...
    'Adjustments' => 'Ajustes',
    'Admin Notices' => 'Avisos da administração',
    ...
    'All variants must have a SKU.' => 'Todas as variantes devem ter um SKU.',
    'All' => 'Tudo',
    ...
    'Available for purchase?' => 'Disponível para compra?',
    'Available inventory for "{description}" has gone below zero.' => 'O stock disponível de "{description}" ficou abaixo de zero.',
    ...
    'Cancel with gateway now' => 'Cancelar agora através do gateway',
    'Cancel' => 'Cancelar',
    ...
    'Card' => 'Cartão',
    'Cart Recovery Link' => 'Link para recuperar o carrinho',
    ...
    'Choose a new customer' => 'Escolha um novo cliente',
    ...
    'Condition' => 'Condição',
    'Conditions here are matched against an order before looking through the rules. This is useful if you want to qualify a method’s availability early, or if there are common conditions to all rules for this method.' => 'As condições são comparadas com uma ordem antes de examinar as regras. É útil para qualificar antecipadamente a disponibilidade de um método ou se houver condições comuns a todas as regras para esse método.',
    'Conditions here are matched against the order’s customer before looking through the rules. This is useful if you want qualify a method’s availability early or if there are common conditions to all rules for this method.' => 'As condições aqui são comparadas com o cliente do pedido antes de consultar as regras. Isso é útil se quiser qualificar a disponibilidade de um método antecipadamente, ou se houver condições comuns a todas as regras para esse método.',
    'Conditions' => 'Condições',
    'Contains Purchasables' => 'Contém artigos de compra',
    ...
    'Coupon can not apply discount to this order due to address mismatch.' => 'O cupão não consegue aplicar desconto a este pedido devido a incompatibilidade de endereço.',
    'Coupon can not apply discount to this order due to customer mismatch.' => 'O cupão não consegue aplicar desconto a este pedido devido a incompatibilidade com o cliente.',
    'Coupon can not apply discount to this order.' => 'O cupão não consegue aplicar desconto a este pedido.',
    ...
    'Coupons' => 'Cupões',
    'Craft Commerce - Administration' => 'Craft Commerce - Administração',
    'Craft Commerce - Inventory' => 'Craft Commerce - Inventário',
    'Craft Commerce - Orders' => 'Craft Commerce - Pedidos',
    'Craft Commerce - Product Type - {name}' => 'Craft Commerce - Tipo de produto - {name}',
    'Craft Commerce - Subscriptions' => 'Craft Commerce - Subscrições',
    ...
    'Create rules that allow this gateway to match the billing address.' => 'Crie regras que permitam que este gateway corresponda ao endereço de faturação.',
    'Create rules that allow this gateway to match the order.' => 'Crie regras que permitam que este gateway corresponda ao pedido.',
    'Create rules that allow this gateway to match the shipping address.' => 'Crie regras que permitam que este gateway corresponda à morada de entrega.',
    ...
    'Has Admin Notices' => 'Tem avisos da administração',
    ...
    'How products should be labeled within the control panel.' => 'Como os produtos devem ser rotulados no painel de controlo.',
    ...
    'How variants should be labeled within the control panel.' => 'Como as variantes devem ser rotuladas no painel de controlo.',
    ...
    'Leave gateway subscription as-is' => 'Deixar a subscrição do gateway tal como está',
    ...
    'Live' => 'Publicado',
    'Location' => 'Local',
    'Locations that should be available for previewing products in this product type.' => 'Locais que devem estar disponíveis para pré-visualização de produtos deste tipo.',
    'MM' => 'MM',
    ...
    'No new customer selected.' => 'Não foi selecionado nenhum novo cliente.',
    ...
    'Order customer data removed.' => 'Solicitar a remoção dos dados do cliente.',
    ...
    'Product type settings' => 'Definições do tipo de produto',
    'Product' => 'Produto',
    ...
    'Quantity' => 'Quantidade',
    'Rate' => 'Taxa',
    'Reassign {numOrders, plural, =1{order} other{orders}}' => 'Reatribuir {numOrders, plural, one {}=1{pedido} other{pedidos}}',
    ...
    'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below' => 'Remover a associação do cliente e o endereço de e-mail {numOrders, plural, one {}=1{do pedido} other{dos pedidos}}. Se desejar, selecione abaixo os dados adicionais do cliente que pretende eliminar',
    'Remove customer data' => 'Remover dados dos clientes',
    ...
    'The cart recovery link is invalid. Please request a new one.' => 'O link de recuperação do carrinho não é válido. Solicite um novo.',
    ...
    'The coupon "{code}" has exceeded its usage limit of {limit}.' => 'O cupão "{code}" ultrapassou o seu limite de utilização de {limit}.',
    'The customer for this order has been deleted.' => 'O cliente associado a este pedido foi eliminado.',
    'The default shipping category is automatically available to all product types.' => 'A categoria de envio padrão está automaticamente disponível para todos os tipos de produtos.',
    'The discount "{name}" has exceeded its total usage limit of {limit}.' => 'O desconto "{name}" ultrapassou o seu limite total de utilização de {limit}.',
    'The download link has expired. Please request a new one.' => 'O link de download expirou. Por favor, solicite um novo.',
    ...
    'The site the order was made in.' => 'O site onde o pedido foi feito.',
    'The site to be used when this email is rendered.' => 'O site a utilizar quando este e-mail for apresentado.',
    ...
    'This category will be used as the default for all purchasables in this store.' => 'Esta categoria será utilizada como padrão para todas as compras nesta loja.',
    ...
    'Unable to complete order: another request is already in progress.' => 'Não foi possível concluir o pedido: já existe outro pedido em curso.',
    ...
    'Unable to reassign orders.' => 'Não é possível reatribuir pedidos.',
    'Unable to remove order data.' => 'Não foi possível eliminar os dados do pedido.',
    ...
    'Variant UI Label Format' => 'Formato da etiqueta de interface variante',
    ...
    'You do not have permission to load this cart.' => 'Não tem permissão para carregar este carrinho.',
    ...
    'You must be logged in or provide a valid token to load this cart.' => 'Tem de iniciar sessão ou fornecer um token válido para carregar este carrinho.',
    ...
    'Your Cart Recovery Link' => 'Link para recuperar o seu carrinho',
    ...
    '{numOrders, number} {numOrders, plural, =1{order is} other{orders are}} associated with the {numUsers, plural, =1{user} other{users}}.' => '{numOrders, number} {numOrders, plural, one {}=1{pedido é} other{pedidos são}} associated with the {numUsers, plural, one {}=1{utilizador} other{utilizadores}}.',
    '{numSubscriptions, number} {numSubscriptions, plural, =1{subscription is} other{subscriptions are}} activated for the {numUsers, plural, =1{user} other{users}}.' => '{numSubscriptions, number} {numSubscriptions, plural, one {}=1{subscrição está} other{subscrições estão}} ativada para {numUsers, plural, one {}=1{utilizador} other{utilizadores}}.',
