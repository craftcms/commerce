...
- Catalog pricing rules now support flexible product and variant matching, based on an product and variant conditions. ([#3544](https://github.com/craftcms/commerce/issues/3544))
