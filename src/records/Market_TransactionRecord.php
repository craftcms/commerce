...
class Market_TransactionRecord extends BaseRecord
{
	...
	{
		return array(
			'parent'        => array(self::BELONGS_TO, 'Market_TransactionRecord', 'onDelete' => self::RESTRICT, 'onUpdate' => self::CASCADE),
			'user'          => array(self::BELONGS_TO, 'UserRecord', 'onDelete' => self::RESTRICT, 'onUpdate' => self::CASCADE),
			'paymentMethod' => array(self::BELONGS_TO, 'Market_PaymentMethodRecord', 'onDelete' => self::RESTRICT, 'onUpdate' => self::CASCADE),
