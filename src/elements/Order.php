 ...
 * @property \craft\commerce\elements\LineItem[]      $lineItems
 * @property \craft\commerce\models\Address           $billingAddress
 * @property \craft\commerce\models\Customer          $customer
 * @property \craft\commerce\models\Address           $shippingAddress
 * @property \craft\commerce\models\OrderAdjustment[] $adjustments
 * @property Commerce_PaymentMethodModel              $paymentMethod
 * @property Commerce_TransactionModel[]              $transactions
 * @property \craft\commerce\models\OrderStatus       $orderStatus
