...
class m150414_124551_market_EmailRecord extends BaseMigration
{
	...
	public function safeUp()
	{
        ...
        craft()->db->createCommand()->createTable('market_emails', [
            ...
            'to'           => ['maxLength' => 255, 'column' => 'varchar', 'required' => true],
            'bcc'          => ['maxLength' => 255, 'column' => 'varchar'],
            'type'         => ['values' => ['plain_text', 'html'], 'column' => 'enum', 'required' => true],
            'enabled'      => ['maxLength' => 1, 'default' => false, 'required' => true, 'column' => 'tinyint', 'unsigned' => true],
