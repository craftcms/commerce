...
class Install extends Migration
{
    ...
    public function dropTables()
    {
        ...
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_countries}}', $this);
        ...
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_discounts}}', $this);
        $this->dropTableIfExists('{{%commerce_discounts}}');
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_emails}}', $this);
        $this->dropTableIfExists('{{%commerce_emails}}');
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_gateways}}', $this);
        ...
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_orderstatuses}}', $this);
        $this->dropTableIfExists('{{%commerce_orderstatuses}}');
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_paymentcurrencies}}', $this);
        ...
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_sales}}', $this);
        $this->dropTableIfExists('{{%commerce_sales}}');
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_shippingcategories}}', $this);
        $this->dropTableIfExists('{{%commerce_shippingcategories}}');
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_shippingmethods}}', $this);
        ...
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_shippingzones}}', $this);
        ...
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_taxcategories}}', $this);
        ...
        MigrationHelper::dropAllForeignKeysOnTable('{{%commerce_taxzones}}', $this);
