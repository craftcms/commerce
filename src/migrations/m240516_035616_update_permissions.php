 ...
 */
class m240516_035616_update_permissions extends Migration
{
    /**
     * @inheritdoc
     */
    public function safeUp(): bool
    {
        ...
        $newPermissions = [
            "commerce-manageSubscriptionPlans" => "commerce-manageSubscriptions",
            "commerce-manageDonationSettings" => "commerce-manageStoreSettings",
        ];
