...
class ShippingMethodOrderCondition extends OrderCondition implements HasStoreInterface
{
    use StoreTrait;
    ...
    {
        throw new LogicException('Shipping Method Order Condition does not support queries');
    }
