...
class ResaveCartsCommand extends ResaveCommand
{
    #[Override]
    protected $signature = 'craft:resave:carts' . self::DEFAULT_OPTIONS;

    #[Override]
    protected $description = 'Re-saves Commerce carts.';

    #[Override]
    protected $aliases = ['resave/carts'];
