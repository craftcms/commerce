...
Craft.Commerce.ChartCurrencyTicks = function (value, index, values) {
  return new Intl.NumberFormat(window.commerceCurrentLocale, {
    style: 'currency',
    currency: window.commerceCurrency,
  }).format(value);
};
...
Craft.Commerce.Chart = Garnish.Base.extend({
        ...
        tooltips: {
          ...
          callbacks: {
            ...
            label: function (tooltipItem, data) {
              ...
              if (
                ...
                data.datasets[tooltipItem.datasetIndex].yAxisID == 'revenue'
              ) {
          ...
          custom: function (tooltipModel) {
            ...
            if (!tooltipEl) {
              ...
              tooltipEl.innerHTML =
                '<div class="chartjs-tooltip-container"></div>';
  ...
  init: function (id, settings) {
    ...
    if (this.$container.length && settings.chart) {
      ...
      if (
        ...
        options.data.datasets = this.mergeDatasetsDefaults(
          options.data.datasets,
          options.type
        );
      }
      ...
      if (type == 'line') {
        tmp = deepmerge(tmp, {
          ...
          pointBackgroundColor:
            Craft.Commerce.ChartColors.borderColors()[colorsIndex],
        });
      }
  ...
  renderChart: function (options) {
    Chart.defaults.global = deepmerge(
