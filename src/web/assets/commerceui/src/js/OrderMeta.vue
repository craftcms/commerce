<template>
  <div>
    <!--                    <pre><code>{{$root.draft}}</code></pre>-->
    <!--                            <div class="buttons">-->
    <!--                                <a class="btn" @click.prevent="someAction()">Some Action</a>-->
    <!--                            </div>-->
    <div id="settings" class="meta">
      ...
      <div class="field" id="reference-field">
        ...
        <div class="input ltr">
          <input class="text fullwidth" type="text" id="couponCode" name="reference"
                 v-bind="$root.draft.order.reference" autocomplete="off" autocorrect="off" autocapitalize="off"
      ...
      <div class="field" id="couponCode-field">
        ...
        <div class="input ltr">
          <input class="text fullwidth" type="text" id="couponCode" name="couponCode" value="" autocomplete="off"
                 autocorrect="off" autocapitalize="off" placeholder="Enter coupon code">
        </div>
      </div>
    ...
    <div class="meta read-only">
      ...
      <div class="data">
        ...
        <span class="value" v-html="$root.draft.order.paidStatusHtml"></span>
      </div>
