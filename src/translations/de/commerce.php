...
return [
    ...
    'Add Product to Sale' => 'Produkt zu Aktion hinzufügen',
    'Add this product to an existing sale. This will change the conditions of the sale, please review the sale.' => 'Dieses Produkt einer Aktion hinuzfügen. Dies ändern die Konditionen der Aktion, bitte prüfen Sie diese.',
    ...
    'Billing detail update URL' => 'URL der Seite für Aktualisierungen der Zahlungsmethode',
    'Both' => 'Beide',
    ...
    'Changing this value may affect your ability to refund existing transactions.' => 'Eine Änderung an dieser Einstellung kann Rückvergütungsmöglichkeiten bestehender Transaktionen beinträchtigen.',
    ...
    'Choose a color to represent the order’s status' => 'Wählen Sie eine Farbe für diesen Bestellstatus.',
    'City' => 'Stadt',
    'Code' => 'Code',
    'Collapse' => 'Einklappen',
    'Color' => 'Farbe',
    ...
    'Create a new sale' => 'Neue Aktion erstellen',
    ...
    'Default - Allow the price to be negative if discounts are greater than the order value.' => 'Standard - Der Preis darf negativ sein wenn Ermäßigungen grösser als der Bestellwert sind.',
    ...
    'Failed to start' => 'Aktivierungsfehler',
    ...
    'Payment method issue' => 'Fehler bei Zahlung',
    ...
    'Purchase (Authorize and Capture Immediately' => 'Kaufen (Autorisieren und sofort Erfassen)',
    ...
    'Search customers by name, email, address or order reference/number…' => 'Kundensuche nach Name, E-Mail Adresse, Anschrift oder Bestellnummer/-referenz…',
    'Select' => 'Auswählen',
    ...
    'Shipping - Minimum cost is the shipping cost, if the order price is less than the shipping cost.' => 'Versand - Der Mindestbestellpreis ist gleich der Höhe der Versandkosten, wenn der Bestellwert kleiner als die Versandkosten ist.',
    ...
    'Stock' => 'Lager',
    'Subject' => 'Betreff',
    'Subscription Settings' => 'Abonnements-Einstellungen',
    'Target' => 'Ziel',
    'Tax' => 'Steuer',
    'Tax Categories' => 'Steuerklassen',
    ...
    'The default view that is shown when viewing Commerce in the CP. If the user does not have permission it will fallback to a location they can access.' => 'Legt fest, welche Ansicht beim Aufrufen von Commerce im Controlpanel angezeigt werden soll. Fehlt dem Benutzer die entsprechende Berechtigung, wird stattdessen eine Ansicht gewählt, die dieser sehen darf.',
    ...
    'The url to the page that will hold the page for updating billing details for a subscription as well as handle 3DS authentication.' => 'Die URL der Seite, auf welcher die Angaben zur Bezahlung eines Abonnements sowie der 3DS Autorisierung angezeigt werden.',
    ...
    'This determines how the Products and Categories are related to match the sale. See Relations Terminology.' => 'Legt die Art und Weise fest, mit der geprüft wird, ob die Produkte und Kategorien zur Aktion gehören',
    'Times Used' => 'Häufigkeit des Gebrauchs',
    'Title' => 'Titel',
    'To' => 'An',
    'to' => 'bis',
    'Total Paid' => 'Insgesamt bezahlt',
    'Total Payable' => 'Insgesamt zu bezahlen',
    ...
    'Yes' => 'Ja',
    'YYYY' => 'JJJJ',
    'You currently have no emails configured to select for this status.' => 'Sie haben gegenwärtig keine E-Mails konfiguriert, die für diesen Status gewählt werden können.',
    'Zero - Minimum price is zero if discounts are greater than the order value.' => 'Null - Der minimale Preis wird auf 0 gesetzt, wenn Ermäßigungen den Bestellwert überschreiten.',
    'Zip Code' => 'Postleitzahl',
    '{name} (Primary)' => '{name} (Hauptname)',
    '{number} more…' => '{number} mehr …',
    'for which this sale will be applicable to. Leave all purchasable fields blank for any purchasable.' => 'für die die Aktion gelten soll. Wenn Sie dies leer lassen, gilt die Aktion für alle käuflichen Produkte.',
    ...
    'Select how the sale will be applied to the purchasable.' => 'Wählen Sie, wie die Aktion auf die käuflichen Produkte angewendet wird.',
    'Subscription date' => 'Abonnementdatum',
    'Enabled' => 'Aktiviert',
    'No subscriptions exist for this user yet.' => 'Für diesen Benutzer sind noch keine Abonnemente vorhanden.',
    ...
    'Stops subsequent?' => 'Nicht automatisch verlängert?',
    ...
    'Categories that the purchasables must be related to. Leave blank for all categories.' => 'Kategorien, mit welchen die käuflichen Produkte verbunden werden müssen. Wenn Sie es leer lassen, gelten alle Kategorien.',
    ...
    'What this subscription plan will be called in the CP.' => 'Wie dieses Abonnement im Kontrollzentrum genannt wird.',
    ...
    'Purchasables for which this sale will be applicable to. Leave all purchasable fields blank for any purchasable.' => 'Käufliche Produkte für diese Aktion. Leerlassen, wenn die Aktion für alle Produkte gelten soll.',
    ...
    'The unique SKU of the donation purchasable.' => 'Die einzigartige SKU für das käufliche Produkt zur Spende.',
