...
return [
    ...
    'Live' => 'Aktiv',
    'MM' => 'MM',
    'Make Payment' => 'Eine Zahlung tätigen',
    ...
    'Order Total Quanity' => 'Gesamtbestellmenge',
    ...
    'Previously selected shipping method is longer available.' => 'Die zuvor gewählte Versandoption ist nicht mehr verfügbar.',
    'Price of {description} increased from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Preis von {description} von {originalSalePriceAsCurrency} zu {newSalePriceAsCurrency} erhöht',
    'Price of {description} was reduced from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Preis von {description} wurde von {originalSalePriceAsCurrency} zu {newSalePriceAsCurrency} gesenkt',
    'Price' => 'Preis',
...
Prozentwerte sind auf zwei Dezimalstellen gerundet.',
    ...
    'The weight of the cart to match this rule match this rule. A zero value disables the limit for each condition.' => 'Das Gewicht im Warenkorb, auf welche diese Regel zutrifft. Ein Nullwert deaktiviert das Limit für jede Bedingung.',
    ...
    'What product URIs should look like for the site.' => 'Wie Produkt-URLs für diese Website aussehen sollen.',
    ...
    '{description} is no longer available and was removed.' => '{description} ist nicht mehr verfügbar und wurde entfernt.',
