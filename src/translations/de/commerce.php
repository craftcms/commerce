...
return [
    ...
    'The price of {description} increased from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Preis von {description} von {originalSalePriceAsCurrency} zu {newSalePriceAsCurrency} erhöht',
    'The price of {description} was reduced from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Preis von {description} wurde von {originalSalePriceAsCurrency} zu {newSalePriceAsCurrency} gesenkt',
    'Price' => 'Preis',
...
Prozentwerte sind auf zwei Dezimalstellen gerundet.',
    ...
    '{description} is no longer available.' => '{description} ist nicht mehr verfügbar und wurde entfernt.',
