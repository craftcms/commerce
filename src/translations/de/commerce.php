...
return [
    ...
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `postalCode` variable.)' => 'Bitte spezifizieren Sie eine <a href="{url}">Twig Bedingung</a>, die feststellt, ob eine Versandzone eine gegebene Postleitzahl einschließen soll. (Die Postleitzahl kann über eine `postalCode` Variable referenziert werden.)',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the tax zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `postalCode` variable.)' => 'Bitte spezifizieren Sie eine <a href="{url}">Twig Bedingung</a>, die feststellt, ob eine Steuerzone eine gegebene Postleitzahl einschließen soll. (Die Postleitzahl kann über eine `postalCode` Variable referenziert werden.)',
