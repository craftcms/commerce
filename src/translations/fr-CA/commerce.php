...
return [
    ...
    'A cart recovery link has been sent to {email}.' => 'A cart recovery link has been sent to {email}.',
    ...
    'Available for purchase?' => 'Disponible à l’achat?',
    'Available inventory for "{description}" has gone below zero.' => 'Available inventory for "{description}" has gone below zero.',
    ...
    'Cancel with gateway now' => 'Cancel with gateway now',
    'Cancel' => 'Annuler',
    ...
    'Card' => 'Carte',
    'Cart Recovery Link' => 'Cart Recovery Link',
    ...
    'Choose a new customer' => 'Choose a new customer',
    ...
    'Contains Purchasables' => 'Contains Purchasables',
    ...
    'Craft Commerce - Inventory' => 'Craft Commerce - Inventory',
    'Craft Commerce - Orders' => 'Craft Commerce - Orders',
    'Craft Commerce - Product Type - {name}' => 'Craft Commerce - Product Type - {name}',
    'Craft Commerce - Subscriptions' => 'Craft Commerce - Subscriptions',
    ...
    'Create rules that allow this gateway to match the billing address.' => 'Create rules that allow this gateway to match the billing address.',
    ...
    'Create rules that allow this gateway to match the shipping address.' => 'Create rules that allow this gateway to match the shipping address.',
    ...
    'Has Admin Notices' => 'Has Admin Notices',
    ...
    'Leave gateway subscription as-is' => 'Leave gateway subscription as-is',
    ...
    'No new customer selected.' => 'No new customer selected.',
    ...
    'Order customer data removed.' => 'Order customer data removed.',
    ...
    'Quantity' => 'Quantité',
    'Rate' => 'Taux',
    'Reassign {numOrders, plural, =1{order} other{orders}}' => 'Reassign {numOrders, plural, =1{order} other{orders}}',
    ...
    'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below' => 'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below',
    'Remove customer data' => 'Remove customer data',
    ...
    'The cart recovery link is invalid. Please request a new one.' => 'The cart recovery link is invalid. Please request a new one.',
    ...
    'The coupon "{code}" has exceeded its usage limit of {limit}.' => 'The coupon "{code}" has exceeded its usage limit of {limit}.',
    ...
    'The discount "{name}" has exceeded its total usage limit of {limit}.' => 'The discount "{name}" has exceeded its total usage limit of {limit}.',
    'The download link has expired. Please request a new one.' => 'The download link has expired. Please request a new one.',
    ...
    'Unable to complete order: another request is already in progress.' => 'Unable to complete order: another request is already in progress.',
    ...
    'Unable to reassign orders.' => 'Unable to reassign orders.',
    'Unable to remove order data.' => 'Unable to remove order data.',
    ...
    'Your Cart Recovery Link' => 'Your Cart Recovery Link',
    ...
    '{numOrders, number} {numOrders, plural, =1{order is} other{orders are}} associated with the {numUsers, plural, =1{user} other{users}}.' => '{numOrders, number} {numOrders, plural, =1{order is} other{orders are}} associated with the {numUsers, plural, =1{user} other{users}}.',
    '{numSubscriptions, number} {numSubscriptions, plural, =1{subscription is} other{subscriptions are}} activated for the {numUsers, plural, =1{user} other{users}}.' => '{numSubscriptions, number} {numSubscriptions, plural, =1{subscription is} other{subscriptions are}} activated for the {numUsers, plural, =1{user} other{users}}.',
