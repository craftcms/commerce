...
return [
    ...
    'Explain what this PDF is used for.' => 'Expliquer l\'utilité de ce PDF.',
    ...
    'The name of shipping method as it will be displayed to the customer and in the control panel.' => 'Le nom du mode d\'expédition tel qu\'affiché pour le client et dans le panneau de configuration.',
    ...
    'The template to be used for HTML PDFs.' => 'Le modèle utilisé pour les PDF HTML.',
    'Can not preview email.' => 'Impossible de prévisualiser le courriel.',
    'No pdfs exist yet.' => 'Il n\'existe pour l\'instant aucun pdf.'
];
