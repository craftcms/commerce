...
return [
    ...
    'The template to be used for HTML emails. Twig code can be used here.' => 'Le modèle à utiliser pour les courriels en HTML. Du code Twig peut être utilisé ici.',
    ...
    'New line items get this status by default' => 'Statut par défaut des nouveaux articles',
    ...
    'How the Purchasables and Categories are related, which determines the matching items. See [Relations Terminology](https://docs.craftcms.com/v3/relations.html#terminology).' => 'La relation entre les biens à acheter et les catégories, qui détermine les articles correspondants. Voir [Terminologie des relations](https://docs.craftcms.com/v3/relations.html#terminology).',
    ...
    'What this shipping method will be called in the control panel.' => 'Nom de cette méthode d\'expédition dans le panneau de configuration.',
