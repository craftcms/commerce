...
return [
    ...
    'Copied!' => 'Copié!',
    'Copy the URL. This URL will load the cart into the user’s session, making it the active cart.' => 'Copier l\'URL. Cette URL chargera le panier dans la session de l\'utilisateur, ce qui en fera le panier actif.',
