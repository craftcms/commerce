...
return [
    ...
    'Discount is not allowed for the customer' => 'Aucun rabais n’est pas autorisé pour le client',
    ...
    'Order Total Quanity' => 'Quantité totale de la commande',
    ...
    'Previously selected shipping method is longer available.' => 'Le mode d\'expédition précédemment sélectionné n\'est plus disponible.',
    'Price of {description} increased from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Le prix de {description} a augmenté de {originalSalePriceAsCurrency} à {newSalePriceAsCurrency}',
    'Price of {description} was reduced from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Le prix de {description} a diminué de {originalSalePriceAsCurrency} à {newSalePriceAsCurrency}',
    'Price' => 'Prix',
    ...
    'The weight of the cart to match this rule match this rule. A zero value disables the limit for each condition.' => 'Le poids du panier correspondant à cette règle. Une valeur nulle désactive la limite pour chaque condition.',
    ...
    'You must be logged in to load this cart.' => 'Vous devez être connecté pour charger ce panier.',
    ...
    '{explanation} Coupon removed.' => 'Coupon removed: {explanation}',
