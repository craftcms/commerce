...
return [
    ...
    'Feet (ft)' => 'Pieds (pi)',
    'No currency exists with the ID “{id}”' => 'Il n\'existe aucune monnaie avec l’identifiant « {id} »',
    ...
    'Can not find email' => 'Impossible de trouver le courriel',
    ...
    'Email “{email}”, for order "{order}" was cancelled by plugin.' => 'Le courriel « {email} » pour la commande « {order} » a été annulé par le plugiciel.',
    ...
    'Couldn’t updated discounts status.' => 'Impossible de mettre à jour le statut des rabais.',
