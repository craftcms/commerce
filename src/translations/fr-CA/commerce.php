...
return [
    ...
    'Failed to update {num, plural, =1{order status}, other{order statuses}}.' => 'Échec de la mise à jour {num, plural, =1{de l\'état de la commande }, other{des états des commandes}}.',
    'Failed updating order status on {num, plural, =1{order}, other{orders}}.' => 'Échec de la mise à jour de l\'état de la commande de {num, plural, =1{commande}, other{commandes}}.',
    'Feet (ft)' => 'Pieds (pi)',
