...
return [
    ...
    'Addresses' => 'Adresses',
    'Adjust price when included rate is disqualified?' => 'Ajuster le prix lorsque le taux d\'imposition inclus est disqualifié?',
    ...
    'If enabled and this rate does not match the order, the rate amount will be removed from the subject price in the cart.' => 'Si cette option est activée et que ce tarif ne correspond pas à la commande, le taux sera supprimé du prix de l\'item dans le panier.',
