...
return [
    ...
    'Couldn’t updated catalog pricing rules status.' => 'Não foi possível atualizar o estado das regras de fixação de preços do catálogo.',
    ...
    'Ignore Promtoions?' => 'Ignorar promoções?',
