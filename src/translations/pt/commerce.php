...
return [
    ...
    'Live' => 'Publicado',
    'MM' => 'MM',
    'Make Payment' => 'Fazer um pagamento',
    ...
    'Order Total Quanity' => 'Quantidade total do pedido',
    ...
    'Previously selected shipping method is longer available.' => 'Já não está disponível o método de envio selecionado anteriormente.',
    'Price of {description} increased from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'O preço de {description} subiu de {originalSalePriceAsCurrency} para {newSalePriceAsCurrency}',
    'Price of {description} was reduced from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'O preço de {description} baixou de {originalSalePriceAsCurrency} para {newSalePriceAsCurrency}',
    'Price' => 'Preço',
    ...
    'The weight of the cart to match this rule match this rule. A zero value disables the limit for each condition.' => 'O peso do carrinho a corresponder a esta regra. Um valor zero desativa o limite em cada condição.',
    ...
    '{description} is no longer available and was removed.' => '{description} já não está disponível e foi removido.',
    '{description} only has {stock} in stock.' => '{description} só tem {stock} em stock.',
    '{explanation} Coupon removed.' => 'Cupão removido: {explanation}',
