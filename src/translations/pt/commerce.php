...
return [
    ...
    'Copied!' => 'Copiado!',
    'Copy the URL. This URL will load the cart into the user’s session, making it the active cart.' => 'Copie o URL. Este URL irá carregar o carrinho para a sessão do utilizador, transformando-o no carrinho ativo.',
    ...
    'Invalid order condition syntax.' => 'Sintaxe da condição inválida.',
    ...
    'Plan Information Entry' => 'Entrada de informação do plano',
    'Plan' => 'Plano',
    ...
    'Select how the sale will be applied to the purchasable(s).' => 'Selecione como a venda será aplicada aos itens que podem ser comprados.',
    ...
    'Set the sale price to a percentage of the original price' => 'Defina o preço de venda como uma percentagem do preço original',
    ...
    'The primary currency cannot be changed after orders are placed.' => 'A moeda principal não pode ser alterada depois de feitos os pedidos.',
    ...
    'The weight of the cart to match this rule match this rule. A zero value disables the limit for each condition.' => 'O peso do carrinho que corresponde a esta regra. Um valor zero desativa o limite em cada condição.',
    ...
    '{description} is no longer available and was removed.' => '{description} is no longer available and was removed.',
