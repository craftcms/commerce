...
return [
    ...
    'Conditions here are matched against the order’s customer before looking through the rules. This is useful if you want qualify a method’s availability early or if there are common conditions to all rules for this method.' => 'Aqui, as condições são comparadas com o cliente da encomenda antes de serem analisadas as regras. Isto é útil se quiser qualificar antecipadamente a disponibilidade de um método, ou se existirem condições comuns a todas as regras para este método.',
    ...
    'Coupon can not apply discount to this order due to address mismatch.' => 'O cupão não pode aplicar o desconto a esta encomenda devido a endereço incorreto.',
    'Coupon can not apply discount to this order due to customer mismatch.' => 'O cupão não pode aplicar o desconto a esta encomenda devido a incompatibilidade com o cliente.',
    'Coupon can not apply discount to this order.' => 'O cupão não pode aplicar o desconto a esta encomenda.',
    ...
    'Create rules that allow this gateway to match the order.' => 'Criar regras que permitam a esta porta de entrada corresponder à encomenda.',
