...
return [
    ...
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `postalCode` variable.)' => 'Especifique uma <a href="{url}">condição Twig</a> que determina se a zona de envio deve incluir um código postal. (O código postal pode ser referenciado através de uma variável \'postalCode\'.)',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the tax zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `postalCode` variable.)' => 'Especifique uma <a href="{url}">condição Twig</a> que determina se a zona de taxa deve incluir um código postal. (O código postal pode ser referenciado através de uma variável \'postalCode\'.)',
