...
return [
    ...
    'A cart recovery link will be sent to {email}.' => 'Er wordt een link voor het herstellen van de winkelwagen verstuurd naar {email}.',
    ...
    'Address copied to user.' => 'Adres gekopieerd naar gebruiker.',
    'Address not found.' => 'Adres niet gevonden.',
    'Adjust Quantity' => 'Hoeveelheid aanpassen',
    'Adjust by' => 'Aanpassen met',
    ...
    'All variants must have a SKU.' => 'Alle varianten moeten een SKU hebben.',
    'All' => 'Alle',
    ...
    'Card' => 'Kaart',
    'Cart Recovery Link' => 'Link voor het herstellen van de winkelwagen',
    ...
    'Conditions here are matched against the order’s customer before looking through the rules. This is useful if you want qualify a method’s availability early or if there are common conditions to all rules for this method.' => 'Voorwaarden hier worden vergeleken met de klant van de bestelling voordat de regels worden bekeken. Dit is handig als u de beschikbaarheid van een methode vroegtijdig wilt kwalificeren of als er gemeenschappelijke voorwaarden zijn voor alle regels voor deze methode.',
    ...
    'Coupon can not apply discount to this order due to address mismatch.' => 'Met deze coupon kan geen korting worden toegepast op deze bestelling omdat het adres niet overeenkomt.',
    'Coupon can not apply discount to this order due to customer mismatch.' => 'Met deze coupon kan geen korting worden toegepast op deze bestelling omdat de klant niet overeenkomt.',
    'Coupon can not apply discount to this order.' => 'Met deze coupon kan geen korting worden toegepast op deze bestelling.',
    ...
    'Create rules that allow this gateway to match the order.' => 'Maak regels waardoor deze gateway overeenkomt met de bestelling.',
    ...
    'Date First Paid' => 'Datum eerste betaling',
    ...
    'How products should be labeled within the control panel.' => 'Hoe producten op het configuratiescherm gelabeld moeten worden.',
    ...
    'How variants should be labeled within the control panel.' => 'Hoe varianten op het configuratiescherm gelabeld moeten worden.',
    ...
    'Live' => 'Live',
    'Location' => 'Locatie',
    'Locations that should be available for previewing products in this product type.' => 'Locaties die beschikbaar moeten zijn voor het bekijken van een voorbeeld van producten in dit producttype.',
    'MM' => 'MM',
    ...
    'Product type settings' => 'Instellingen voor het producttype',
    'Product' => 'Product',
    ...
    'Recipient' => 'Ontvanger',
    'Recover Cart' => 'Winkelwagen herstellen',
    ...
    'The cart recovery link is invalid. Please request a new one.' => 'De link voor het herstellen van de winkelwagen is ongeldig. Vraag een nieuwe aan.',
    ...
    'The default shipping category is automatically available to all product types.' => 'De standaardverzendcategorie is automatisch beschikbaar voor alle producttypes.',
    ...
    'The site the order was made in.' => 'De site waarop de bestelling is geplaatst.',
    'The site to be used when this email is rendered.' => 'De site die moet worden gebruikt bij het renderen van deze e-mail.',
    ...
    'This category will be used as the default for all purchasables in this store.' => 'Deze categorie wordt gebruikt als standaardcategorie voor alle koopbare artikelen in deze winkel.',
    ...
    'Transfer Fields' => 'Overdrachtvelden',
    ...
    'Variant UI Label Format' => 'Variant UI-labelformaat',
    ...
    'You do not have permission to load this cart.' => 'U heeft geen rechten om deze winkelwagen te laden.',
    ...
    'You must be logged in or provide a valid token to load this cart.' => 'U moet ingelogd zijn of een geldig token verstrekken om deze winkelwagen te laden.',
    ...
    'Your Cart Recovery Link' => 'Uw link voor het herstellen van de winkelwagen',
