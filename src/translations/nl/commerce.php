...
return [
    ...
    'This is the default PDF that will be rendered when requesting the order PDF.' => 'Dit is de standaard pdf die wordt weergegeven bij het opvragen van de bestelling-pdf.',
