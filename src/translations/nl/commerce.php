...
return [
    ...
    'Billing First Name' => 'Vooornaam voor facturering',
    'Trial expiry date' => 'Vervaldatum proefperiode',
    'Couldn’t capture transaction: {message}' => 'Transactie vastleggen niet mogelijk: {message}',
    'subscription' => 'abonnement',
    'URI' => 'URI',
    ...
    'Purchase (Authorize and Capture Immediately)' => 'Kopen (onmiddellijk autoriseren en vastleggen)',
