...
return [
    ...
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `postalCode` variable.)' => 'Geef een <a href="{url}">Twig-voorwaarde</a> op die bepaalt of de verzendingszone een specifieke zip-/postcode moet bevatten. (Via een `postalCode-variabele` kan worden verwezen naar de zip-/postcode.)',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the tax zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `postalCode` variable.)' => 'Geef een <a href="{url}">Twig-voorwaarde</a> op die bepaalt of de belastingzone een specifieke zip-/postcode moet bevatten. (Via een `postalCode-variabele` kan worden verwezen naar de zip-/postcode.)',
