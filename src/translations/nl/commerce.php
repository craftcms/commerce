...
return [
    ...
    'Discount the matching items only' => 'Korting alleen toepassen op overeenstemmende items',
    ...
    'Pounds (lb)' => 'Pond (lb)',
    'Email required to make payments on a completed order.' => 'Het e-mailadres is vereist voor betaling van een voltooide bestelling.',
