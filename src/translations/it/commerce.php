...
return [
    ...
    'Order Total Quanity' => 'Quantità totale dell\'ordine',
    ...
    'Previously selected shipping method is longer available.' => 'Il metodo di spedizione selezionato in precedenza non è più disponibile.',
    'Price of {description} increased from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Il prezzo di {description} è aumentato da {originalSalePriceAsCurrency} a {newSalePriceAsCurrency}',
    'Price of {description} was reduced from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Il prezzo di {description} è diminuito da {originalSalePriceAsCurrency} a {newSalePriceAsCurrency}',
    'Price' => 'Prezzo',
    ...
    'The weight of the cart to match this rule match this rule. A zero value disables the limit for each condition.' => 'Il peso del carrello corrispondente a questa regola. Un valore pari a zero disattiva il limite per ogni condizione.',
    ...
    'You must be logged in to load this cart.' => 'Per caricare questo carrello è necessario effettuare l’accesso.',
    ...
    '{description} is no longer available and was removed.' => '{description} non è più disponibile ed è stato rimosso.',
    '{description} only has {stock} in stock.' => 'Sono disponibili solo {stock} {description} a magazzino.',
    '{explanation} Coupon removed.' => 'Coupon rimosso: {explanation}',
