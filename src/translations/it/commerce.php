...
return [
    ...
    'Failed to update {num, plural, =1{order status}, other{order statuses}}.' => 'Impossibile aggiornare {num, plural, =1{stato dell\'ordine}, other{stati degli ordini}}.',
    'Failed updating order status on {num, plural, =1{order}, other{orders}}.' => 'Impossibile aggiornare stato del\'ordine su {num, plural, =1{ordine}, other{ordini}}.',
    'Feet (ft)' => 'Piedi (ft)',
    ...
    '{num, plural, =1{order}, other{orders}} updated.' => '{num, plural, =1{ordine aggiornato}, other{ordini aggiornati}}.',
