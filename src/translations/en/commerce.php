...
return [
    ...
    'The format used to generate new coupons. `#` characters will be replaced with a random letter.' => 'The format used to generate new coupons. `#` characters will be replaced with a random letter.',
