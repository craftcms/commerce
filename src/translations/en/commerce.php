...
return [
    ...
    'Allows creating drafts of new products.' => 'Allows creating drafts of new products.',
    'Allows deleting products for all sites.' => 'Allows deleting products for all sites.',
    'Allows fully saving canonical products (directly or by applying drafts).' => 'Allows fully saving canonical products (directly or by applying drafts).',
    'Allows viewing existing products and creating drafts for them.' => 'Allows viewing existing products and creating drafts for them.',
    ...
    'View user' => 'View user',
    'View “{type}” products' => 'View “{type}” products',
    'View' => 'View',
    ...
    '{num, number} {num, plural, =1{subscription} other{subscriptions}} via {gateway}.' => '{num, number} {num, plural, =1{subscription} other{subscriptions}} via {gateway}.',
    '{num, plural, =1{Order} other{Orders}} updated.' => '{num, plural, =1{order} other{orders}} updated.',
    '{numUsers, number} {numUsers, plural, =1{user has} other{users have}} {numOrders, number} {numOrders, plural, =1{order} other{orders}} associated.' => '{numUsers, number} {numUsers, plural, =1{user has} other{users have}} {numOrders, number} {numOrders, plural, =1{order} other{orders}} associated.',
