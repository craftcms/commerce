...
return [
    ...
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `postalCode` variable.)' => 'Nastavte <a href="{url}">podmienku Twig</a>, ktorá určí, či má zóna doručenia zahŕňať dané PSČ. (PSČ je možné volať pomocou premennej „postalCode“.)',
