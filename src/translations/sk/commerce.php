...
return [
    ...
    'Order Total Quanity' => 'Celkový počet v objednávke',
    ...
    'Previously selected shipping method is longer available.' => 'Predtým zvolený spôsob dopravy už nie je dostupný.',
    'Price of {description} increased from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Cena {description} sa zvýšila z {originalSalePriceAsCurrency} na {newSalePriceAsCurrency}',
    'Price of {description} was reduced from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Cena {description} sa znížila z {originalSalePriceAsCurrency} na {newSalePriceAsCurrency}',
    'Price' => 'Cena',
    ...
    'Revenue' => 'Výnos',
    'Rule' => 'Pravidlo',
    'Rules reordered.' => 'Pravidlá obnovené.',
    'SKU' => 'SKU',
    ...
    'Specify a <a href="{url}">Twig condition</a> that determines whether the discount should apply to a given order. (The order can be referenced via an `order` variable.)' => 'Nastavte <a href="{url}">podmienku Twig</a>, ktorá určí, či sa má na danú objednávku uplatniť zľava. (Objednávku je možné volať pomocou premennej „order“.)',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping rule should apply to a given order. (The order can be referenced via an `order` variable.)' => 'Nastavte <a href="{url}">podmienku Twig</a>, ktorá určí, či sa má na danú objednávku uplatniť pravidlo dopravy. (Objednávku je možné volať pomocou premennej „order“.)',
    ...
    '{description} is no longer available and was removed.' => '{description} už nie je dostupný a bol odstránený.',
