...
return [
    ...
    'Cancel with gateway now' => 'Cancel using gateway now',
    'Cancel' => 'Cancel',
    ...
    'Order customer data removed.' => 'Customer data removed from orders.',
    ...
    'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below' => 'Remove customer association and email from the {numOrders, plural, one {}=1{order} other{orders}}. Select additional customer data to remove below.',
