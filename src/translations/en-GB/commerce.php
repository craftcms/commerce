...
return [
    ...
    'Available for purchase?' => 'Available for purchase?',
    'Available inventory for "{description}" has gone below zero.' => 'Available inventory for "{description}" has dropped below zero.',
    ...
    'Contains Purchasables' => 'Contains Purchasable Items',
    ...
    'Quantity' => 'Quantity',
    'Rate' => 'Rate',
    'Reassign {numOrders, plural, =1{order} other{orders}}' => 'Reassign {numOrders, plural, one {}=1{order} other{orders}}',
    ...
    'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below' => 'Remove customer association and email from the {numOrders, plural, one {}=1{order} other{orders}}. Optionally, select additional customer data to remove below.',
    ...
    '{numOrders, number} {numOrders, plural, =1{order is} other{orders are}} associated with the {numUsers, plural, =1{user} other{users}}.' => '{numOrders, number} {numOrders, plural, one {}=1{order is} other{orders are}} associated with the {numUsers, plural, one {}=1{user} other{users}}.',
    '{numSubscriptions, number} {numSubscriptions, plural, =1{subscription is} other{subscriptions are}} activated for the {numUsers, plural, =1{user} other{users}}.' => '{numSubscriptions, number} {numSubscriptions, plural, one {}=1{subscription is} other{subscriptions are}} activated for the {numUsers, plural, one {}=1{user} other{users}}.',
