...
return [
    ...
    'Condition' => 'Tilstand',
    'Conditions Rules' => 'Tilstandsregler',
    ...
    'Failed to update {num, plural, =1{order status}, other{order statuses}}.' => 'Kunne ikke oppdatere {num, plural, =1{order status}, other{order statuses}}.',
    'Failed updating order status on {num, plural, =1{order}, other{orders}}.' => 'Kunne ikke oppdatere ordrestatus for {num, plural, =1{order}, other{orders}}.',
    'Feet (ft)' => 'Fot (ft)',
    ...
    'How many times one user is allowed to use this discount. If this is set to something besides zero, the discount will only be available to signed in users.' => 'Hvor mange ganger en bruker har lov til å bruke denne rabatten. Hvis dette er satt til noe annet enn null, vil rabatten kun være tilgjengelig for påloggede brukere.',
    'How many times this discount can be used in total by guests or signed in users. Set zero for unlimited use.' => 'Hvor mange ganger denne rabatten kan bli brukt av gjester eller påloggede brukere. Sett til null for ubegrenset bruk.',
    ...
    'Only orders with the following order statuses will be included. Leave blank to include all statuses.' => 'Kun ordre med følgende ordrestatuser vil bli inkludert. La stå tomt for å inkludere alle statuser.',
    'Options' => 'Valg',
    ...
    'Unable to retrieve payment source.' => 'Kan ikke hente betalingskilde.',
    ...
    'Unable to set primary payment source.' => 'Kan ikke angi primær betalingskilde.',
    ...
    '{num, plural, =1{order}, other{orders} updated.' => '{num, plural, =1{order}, other{orders} oppdatert.',
