...
return [
    ...
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `postalCode` variable.)' => 'Spesifiser en <a href="{url}">Twig-tilstand</a> som bestemmer om fraktsonen skal inkludere et postnummer. (Postnummeret kan henvises til via en postalCode-variabel.)',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the tax zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `postalCode` variable.)' => 'Spesifiser en <a href="{url}">Twig-tilstand</a> som bestemmer om skattesonen skal inkludere et postnummer. (Postnummeret kan henvises til via en postalCode-variabel.)',
