...
return [
    ...
    'Choose the destination inventory location for the existing on hand stock.' => 'Velg målplass i inventar for eksisterende tilgjengelige lagervarer.',
    'City' => 'By',
    ...
    'Condition' => 'Tilstand',
    'Conditions here are matched against an order before looking through the rules. This is useful if you want qualify a method’s availabililty early or if there are common conditions to all rules for this method.' => 'Her matches betingelsene mot en bestilling før reglene blir vurdert. Dette er nyttig hvis du ønsker å kvalifisere en metodes tilgjengelighet tidlig, eller hvis det finnes felles betingelser for alle reglene for denne metoden.',
    ...
    'Length' => 'Lengde',
    'Limit which orders this discount applies to based on its line items.' => 'Begrens hvilke bestillinger denne rabatten gjelder for basert på linjevarer.',
    ...
    'When this discount is applied to an order, which line items should be discounted?' => 'Når denne rabatten blir brukt på en bestilling, hvilke linjevarer skal få rabatt?',
