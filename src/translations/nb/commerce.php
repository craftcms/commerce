...
return [
    ...
    'Previously selected shipping method is longer available.' => 'Tidligere valgt leveringsmetode er ikke lenger tilgjengelig.',
    'Price of {description} increased from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Prisen på {description} har økt fra {originalSalePriceAsCurrency} til {newSalePriceAsCurrency}',
    'Price of {description} was reduced from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => 'Prisen på {description} har blitt redusert fra {originalSalePriceAsCurrency} til {newSalePriceAsCurrency}',
    'Price' => 'Pris',
    ...
    '{description} is no longer available and was removed.' => '{description} er ikke tilgjengelig lenger og er fjernet.',
