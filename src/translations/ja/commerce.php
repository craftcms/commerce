...
return [
    ...
    'At least one site must be enabled for the product type.' => '商品タイプには少なくとも1つのサイトが有効である必要があります。',
    ...
    'Expiry date' => '有効期限',
    'Expiry' => '期日',
    'Failed to receive transfer: {error}' => '移動の入庫に失敗しました: {error}',
    ...
    'Included' => '込み',
    'Incoming transfer from Transfer ID: ' => '移動IDからの入庫予定: ',
    'Incoming' => '入荷',
    'Info' => '情報',
