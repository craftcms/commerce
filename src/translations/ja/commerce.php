...
return [
    ...
    'Specify a <a href="{url}">Twig condition</a> that determines whether the shipping zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `postalCode` variable.)' => '配送地域が特定の郵便番号を含む必要があるかどうかを判断する <a href="{url}">Twig 条件</a>を指定します。（郵便番号は `postalCode` 変数で参照できます。）',
    'Specify a <a href="{url}">Twig condition</a> that determines whether the tax zone should include a given Zip/postal code. (The Zip/postal code can be referenced via a `postalCode` variable.)' => '税対象地域が特定の郵便番号を含む必要があるかどうかを判断する <a href="{url}">Twig 条件</a>を指定します。（郵便番号は `postalCode` 変数で参照できます。）',
    'Start Date' => '開始日',
