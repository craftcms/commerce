...
return [
    ...
    'Couldn’t updated catalog pricing rules status.' => 'カタログ価格ルールのステータスを更新できませんでした。',
    ...
    'Ignore Promtoions?' => 'プロモーションを無視しますか？',
    ...
    'Inventory locations saved.' => '在庫場所が保存されました。',
    ...
    'Last Name' => '姓',
    'Last Updated' => '最終更新日',
    'Leave a category rate override blank to use the rate from above.' => 'カテゴリ率の上書きを空白にすると、上記からの率を使用します。',
    ...
    'Origin' => '原因',
    'Original Price' => '元の価格',
    'Original price' => 'オリジナル価格',
    'Original promotional price' => 'オリジナルの販売促進価格',
    ...
    'Save this inventory location first, then add an address.' => '最初にこの在庫場所を保存してから、住所を追加してください。',
    'Save' => '保存',
    ...
    'Site store mapping saved.' => 'サイトストアマッピングを保存しました。',
    'Sites' => 'サイト',
    'Slug' => 'スラッグ',
    'Snapshot' => 'スナップショット',
    'Snapshots' => 'スナップショット',
    ...
    '{count} Unfulfilled Orders' => '{count}件の未解決注文',
    ...
    '{storeNames} {num, plural, =1{has} other{have}} not been assigned to a site.' => '{storeNames} {num, plural, =1{has} other{have}}はサイトにまだ割り当てられていません。',
    '{total} in total revenue' => '合計収益の {total}',
    '{total} orders' => '注文数 {total}',
    '{total} saleable across {locationCount} location(s)' => '{locationCount}件の場所全体での{total}件の販売可能品',
