...
return [
    ...
    'Failed to update {num, plural, =1{order status}, other{order statuses}}.' => '{num, plural, =1{件の注文ステータス}, other{件の注文ステータス}}の更新に失敗しました。',
    'Failed updating order status on {num, plural, =1{order}, other{orders}}.' => '{num, plural, =1{件の注文}, other{件の注文}}の注文ステータスの更新に失敗しました。',
    'Feet (ft)' => 'フィート（ft）',
    ...
    'Unable to set primary payment source.' => 'プライマリの支払い元に設定できません。',
    ...
    'You must be signed in to set a primary payment source.' => 'プライマリの支払い元を作成するにはサインインする必要があります。',
