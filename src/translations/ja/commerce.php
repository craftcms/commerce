...
return [
    ...
    'Address Line 2' => '住所欄2',
    'Purchasables for which this sale will be applicable to. Leave all purchasable fields blank for any purchasable.' => 'このセールが適用されるパーチャサブルです。任意のパーチャサブルについては、すべてのパーチャサブルフィールドを空欄にします。',
    ...
    'Copy' => 'コピー',
    'Customers' => '顧客',
    'The reply to email address. Leave blank for normal reply to of email sender. Twig code can be used here.' => '返信先メールアドレスです。通常のメール送信者への返信の場合は空欄にします。ここに Twig コードを使用できます。',
    'Search orders' => '注文を検索',
    ...
    'for which this discount will be applicable to. Leave all purchasable fields blank for any purchasable.' => 'このディスカウントの適用先です。任意のパーチャサブルについては、すべてのパーチャサブルフィールドを空欄にします。',
