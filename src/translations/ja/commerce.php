...
カートが注文に変わると、このフォーマットに基づいて管理しやすい参照番号が生成されます。たとえば、{ex1}、または {ex2}。このフォーマットの結果は一意でなければなりません。',
    ...
    'Set as Primary Billing' => 'プライマリの請求先住所にする',
    'Used by Tax Rates' => '税率に使用されている',
    'Copy' => 'コピー',
    'Customers' => '顧客',
    ...
    'Set as Primary Shipping' => 'プライマリの配送先住所にする',
    'Notes' => 'ノート',
    ...
    'Explain what this PDF is used for.' => 'このPDFの用途を説明してください。',
    ...
    'The name of shipping method as it will be displayed to the customer and in the control panel.' => '顧客とコントロールパネルに表示する配送方法の名前。',
    ...
    'Order Settings' => '注文設定',
    'The template to be used for HTML PDFs.' => 'HTML PDFに使用されるテンプレート。',
    'Can not preview email.' => 'メールをプレビューできません。',
    'No pdfs exist yet.' => 'PDFがまだありません。'
];
