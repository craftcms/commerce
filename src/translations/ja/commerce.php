...
return [
    ...
    'Ignore previous matching sales if this sale matches.' => 'このセールが適合する場合に、既存の適合するセールを無視する。',
...
カートが注文に変わると、このフォーマットに基づいて管理しやすい参照番号が生成されます。たとえば、{ex1}、または {ex2}。このフォーマットの結果は一意でなければなりません。',
    ...
    'Search…' => 'Search…',
    'Matching items are those items that are used to match this discount’s conditions. Those on the \'Matching Items\' tab.' => 'マッチングアイテムはこのディスカウントの条件に適合させるアイテムです。「マッチングアイテム」タブで設定します。',
