...
return [
    ...
    'Available inventory for "{description}" has gone below zero.' => '「{description}」の利用可能在庫が0を下回っています。',
    ...
    'Cancel with gateway now' => '今すぐゲートウェイでキャンセル',
    'Cancel' => 'キャンセル',
    ...
    'Choose a new customer' => '新しい顧客を選択',
    ...
    'Conditions' => '条件',
    'Contains Purchasables' => '購入可能商品を含む',
    ...
    'Coupons' => 'クーポン',
    'Craft Commerce - Administration' => 'Craft Commerce - 管理',
    'Craft Commerce - Inventory' => 'Craft Commerce - 在庫',
    'Craft Commerce - Orders' => 'Craft Commerce - 注文',
    'Craft Commerce - Product Type - {name}' => 'Craft Commerce - 商品タイプ - {name}',
    'Craft Commerce - Subscriptions' => 'Craft Commerce - サブスクリプション',
    ...
    'Create rules that allow this gateway to match the billing address.' => 'このゲートウェイを請求先住所と一致させるルールを作成します。',
    'Create rules that allow this gateway to match the order.' => 'このゲートウェイを注文に一致させるルールを作成します。',
    'Create rules that allow this gateway to match the shipping address.' => 'このゲートウェイを配送先住所と一致させるルールを作成します。',
    'Create sales' => 'セールを作成',
    'Create sale…' => 'セールを作成…',
    'Created' => '作成済み',
    ...
    'Leave gateway subscription as-is' => 'ゲートウェイのサブスクリプションを現状のままにします',
    'Length ({unit})' => '長さ（{unit}）',
    'Length' => '長さ',
    ...
    'No new customer selected.' => '新しい顧客が選択されていません。',
    ...
    'Order count' => '注文数',
    'Order customer data removed.' => '注文の顧客データを削除しました。',
    ...
    'Quantity' => '数量',
    'Rate' => '率',
    'Reassign {numOrders, plural, =1{order} other{orders}}' => '{numOrders, plural, =1{注文} other{注文}}を再割り当て',
    ...
    'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below' => '{numOrders, plural, =1{注文} other{注文}}から顧客の関連付けとメールアドレスを削除してください。以下から削除する追加の顧客データを任意で選択してください',
    'Remove customer data' => '顧客データを削除',
    ...
    'The coupon "{code}" has exceeded its usage limit of {limit}.' => 'クーポン「{code}」は利用回数上限（{limit}）を超えています。',
    'The customer for this order has been deleted.' => 'この注文の顧客情報は削除されました。',
    'The default shipping category is automatically available to all product types.' => 'デフォルトの配送カテゴリは、すべての商品タイプで自動的に利用可能です。',
    'The discount "{name}" has exceeded its total usage limit of {limit}.' => 'ディスカウント「{name}」は累計利用回数上限（{limit}）を超えています。',
    'The download link has expired. Please request a new one.' => 'ダウンロードリンクの有効期限が切れました。新しいリンクをリクエストしてください。',
    ...
    'Unable to complete order: another request is already in progress.' => '注文を完了できません：別のリクエストが既に進行中です。',
    ...
    'Unable to reassign orders.' => '注文を再割り当てできません。',
    'Unable to remove order data.' => '注文データを削除できません。',
    ...
    '{numOrders, number} {numOrders, plural, =1{order is} other{orders are}} associated with the {numUsers, plural, =1{user} other{users}}.' => '{numOrders, number} {numOrders, plural, =1{件の注文} other{件の注文}}が、{numUsers, plural, =1{ユーザー} other{ユーザー}}に関連付けられています。',
    '{numSubscriptions, number} {numSubscriptions, plural, =1{subscription is} other{subscriptions are}} activated for the {numUsers, plural, =1{user} other{users}}.' => '{numSubscriptions, number} {numSubscriptions, plural, =1{件のサブスクリプション} other{件のサブスクリプション}}が、{numUsers, plural, =1{ユーザー} other{ユーザー}}に対して有効化されています。',
