...
return [
    ...
    'Could not reactivate “{reference}”.' => '「{reference}」を再アクティブ化できませんでした。',
    ...
    'Previously selected shipping method is longer available.' => '以前に選択した配送方法はご利用いただけません。',
    'Price of {description} increased from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => '{description}の価格が {originalSalePriceAsCurrency} から {newSalePriceAsCurrency} に上がりました',
    'Price of {description} was reduced from {originalSalePriceAsCurrency} to {newSalePriceAsCurrency}' => '{description} の金額が {originalSalePriceAsCurrency} から {newSalePriceAsCurrency} に下がりました',
    'Price' => '価格',
    ...
    'Subscription reactivated.' => '定期支払いを再アクティブ化しました。',
    ...
    'The weight of the cart to match this rule match this rule. A zero value disables the limit for each condition.' => 'このルールに一致するカートの重量。ゼロの値は各条件の制限を無効にします。',
    ...
    'This URL will load the cart into the user’s session, making it the active cart.' => 'この URL はカートをユーザーセッションにロードし、カートをアクティブにします。',
    ...
    'This is the primary billing and shipping address for: {email}' => 'これは次のメールの通常の請求先および配送先住所です：{email}',
    ...
    'Value of products before any discounts are applied.' => 'ディスカウントが適用される前の商品の金額',
