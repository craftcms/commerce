...
return [
    ...
    'If enabled and this rate does not match the order, the rate amount will be removed from the subject price in the cart.' => '有効に設定されていて、この料金が注文と一致しない場合、料金はカートの対象価格から削除されます。',
