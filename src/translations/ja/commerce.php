...
return [
    ...
    'Addresses' => '住所',
    'Adjust price when included rate is disqualified?' => '込みの料金が不適格である場合、価格を調整しますか？',
    ...
    'Discounts deleted.' => 'ディスカウントが削除されました。',
    'Discounts reordered.' => 'ディスカウントを並び替えました。',
    'Discounts updated.' => 'ディスカウントが更新されました。',
    'Discounts' => 'ディスカウント',
    'Disqualify with valid business tax ID?' => '有効な事業税 ID で対象外にしますか？',
    'Do not apply subsequent matching sales beyond applying this sale.' => 'このセールを適用した場合、その後のセールを適用しない。',
    'Do not apply this rate if the order address has any of the selected valid business tax IDs.' => '注文の住所が選択された有効な事業税 ID のものである場合は、この料金を適用しないでください。',
    ...
    'Email' => 'メール',
    'Emails' => 'メール',
    'Enable if this rate should be built into the taxable subject price instead of adding a cost to the order.' => 'コストを注文に追加する代わりに、料金が課税対象価格に組み込まれるかどうかを有効にします。',
    ...
    'If enabled and this rate does not match the order, the rate amount will be removed from the subject price in the cart.' => '有効に設定されていて、この料金が注文と一致しない場合、その料金はカートの対象価格から削除されます。',
    ...
    'Select what this rate should be applied to.' => 'この料金が適用されるべきものを選択してください。',
    'Select' => '選択',
    'Send Email' => 'メールを送信する',
