...
return [
    ...
    'Length' => 'Length',
    'Limit' => 'Limit',
    'Maximum number of matching items that can be ordered for this discount to apply. A zero value here will skip this condition.' => 'このディスカウントの適用に可能となる、条件にあうアイテムの最大数。ここでゼロの値を指定すると、この条件はスキップされます。',
    ...
    'Message' => 'メッセージ',
    'Minimum number of matching items that need to be ordered for this discount to apply.' => 'このディスカウントの適用に必要となる、条件にあうアイテムの最小数。',
