...
return [
    ...
    'A cart recovery link has been sent to {email}.' => 'カート復元リンクを{email}宛に送信しました。',
    'A cart recovery link will be sent to {email}.' => 'カート復元リンクを{email}宛に送信します。',
    ...
    'Address copied to user.' => 'アドレスをユーザーにコピーしました。',
    ...
    'All products' => 'すべての商品',
    'All variants must have a SKU.' => 'すべてのバリアントにはSKUが必要です。',
    'All' => 'すべて',
    ...
    'Condition' => '条件',
    'Conditions here are matched against an order before looking through the rules. This is useful if you want to qualify a method’s availability early, or if there are common conditions to all rules for this method.' => 'ここでの条件は、ルールを調べる前に注文に対して照合されます。これは、前もってメソッドの可用性を評価する場合、またはこのメソッドに対してすべてのルールに共通の条件がある場合に役立ちます。',
    'Conditions here are matched against the order’s customer before looking through the rules. This is useful if you want qualify a method’s availability early or if there are common conditions to all rules for this method.' => 'ここで設定した条件は、ルールを確認する前に注文の顧客情報と照合されます。これは、メソッドの利用可否を早い段階で判断したい場合や、このメソッドに適用されるすべてのルールに共通する条件を設けたい場合に便利です。',
    'Conditions' => '条件',
    ...
    'Country' => '国',
    'Coupon Code' => 'クーポンコード',
    'Coupon can not apply discount to this order due to address mismatch.' => 'アドレスが一致しなかったため、この注文にはクーポンのディスカウントを適用できません。',
    'Coupon can not apply discount to this order due to customer mismatch.' => '顧客が一致しなかったため、この注文にはクーポンのディスカウントを適用できません。',
    'Coupon can not apply discount to this order.' => 'この注文にはクーポンのディスカウントを適用できません。',
    ...
    'Create rules that allow this gateway to match the order.' => 'このゲートウェイを注文に一致させるルールを作成します。',
    ...
    'How products should be labeled within the control panel.' => 'コントロールパネル内での商品の表示方法。',
    ...
    'How variants should be labeled within the control panel.' => 'コントロールパネル内でのバリアントの表示方法。',
    ...
    'Live' => 'ライブ',
    'Location' => '場所',
    'Locations that should be available for previewing products in this product type.' => 'この商品タイプでプレビュー可能にすべき表示場所。',
    'MM' => 'MM',
    ...
    'The cart recovery link is invalid. Please request a new one.' => 'カート復元リンクが無効です。新しいリンクをリクエストしてください。',
    ...
    'The default shipping category is automatically available to all product types.' => 'デフォルトの配送カテゴリは、すべての商品タイプで自動的に利用可能です。',
    ...
    'The site the order was made in.' => '注文が行われたサイト。',
    'The site to be used when this email is rendered.' => 'このメールをレンダリングする際に使用するサイト。',
    ...
    'This category will be used as the default for all purchasables in this store.' => 'このカテゴリは、このストア内のすべてのパーチャサブルのデフォルトとして使用されます。',
    ...
    'Variant UI Label Format' => 'バリアントUIラベルの表示形式',
    ...
    'You do not have permission to load this cart.' => 'このカートを読み込む権限がありません。',
    ...
    'You must be logged in or provide a valid token to load this cart.' => 'カートを読み込むにはログインするか、有効なトークンを入力してください。',
    ...
    'Your Cart Recovery Link' => 'カート復元リンク',
