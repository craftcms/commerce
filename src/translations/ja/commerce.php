...
return [
    ...
    'Zero - Minimum price is zero if discounts are greater than the order value.' => 'ゼロ - ディスカウントが注文価格より大きい場合、最低料金はゼロです。',
    ...
    'Expiry date' => '有効期限',
    'Some products restored.' => '一部の商品が復元されました。',
    ...
    'View order' => '注文を表示',
    'Item Total' => 'アイテム合計',
    'Address ID is required.' => '住所 ID は必須です。',
    ...
    'Refund payment' => '払戻し',
    'Carts' => 'カート',
    'Billing address required.' => '請求先住所は必須です。',
    'Can not refund amount greater than the remaining amount' => '残金より大きい金額を払戻しできません',
    'Can not find order.' => '注文が見つかりません。',
    'Billing' => '請求先',
    ...
    'Default - Allow the price to be negative if discounts are greater than the order value.' => 'デフォルト - ディスカウントが注文価格より大きい場合は価格を負にすることができます。',
    'Create a new PDF' => '新しい PDF を作成',
    'Custom' => 'カスタム',
    'Top Customers by Total Revenue' => '合計収益別上位顧客',
    'Customer ID is required.' => '顧客 ID は必須です。',
    ...
    'Email template parse error for email “{email}” in “Subject:”. Order: “{order}”. Template error: “{message}” {file}:{line}' => '「件名:」 のメール 「{email}」に対し、メールテンプレートの解析エラーが発生しました。注文: 「{order}」。テンプレートエラー: 「{message}」{file}:{line}',
    'Edit Address' => '住所を編集',
    ...
    'Not a valid credit card number.' => '無効なクレジットカード番号ではありません。',
