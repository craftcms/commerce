...
return [
    ...
    'Address copied to user.' => 'アドレスがユーザーにコピーされました。',
    ...
    'Conditions here are matched against the order’s customer before looking through the rules. This is useful if you want qualify a method’s availability early or if there are common conditions to all rules for this method.' => 'ここでの条件は、ルールを調べる前に注文の顧客に対して照合されます。これは、前もってメソッドの可用性を評価したい場合、またはこのメソッドに対してすべてのルールに共通の条件がある場合に有用です。',
    'Conditions' => '条件',
    ...
    'Country' => '国',
    'Coupon Code' => 'クーポンコード',
    'Coupon can not apply discount to this order due to address mismatch.' => 'アドレスの不一致により、この注文にはクーポンのディスカウントを適用できません。',
    'Coupon can not apply discount to this order due to customer mismatch.' => '顧客の不一致により、この注文にはクーポンのディスカウントを適用できません。',
    ...
    'This category will be used as the default for all purchasables in this store.' => 'このカテゴリは、このストア内のすべてのパーチャサブルに対してデフォルトとして使用されます。',
