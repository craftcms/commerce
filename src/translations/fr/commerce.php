...
return [
    ...
    'The template to be used for HTML emails. Twig code can be used here.' => 'Le modèle à utiliser pour les e-mails en HTML. Du code Twig peut être utilisé ici.',
    ...
    'What this shipping method will be called in the control panel.' => 'Nom de ce moyen de livraison dans le panneau de contrôle.',
