...
return [
    ...
    'Available for purchase?' => 'Disponible à l’achat ?',
    'Available inventory for "{description}" has gone below zero.' => 'L\'inventaire disponible pour « {description} » est passé en-dessous de zéro.',
    ...
    'Contains Purchasables' => 'Contient des articles à vendre',
    ...
    'Coupon can not apply discount to this order due to address mismatch.' => 'Le coupon ne peut pas être utilisé pour appliquer une réduction à cette commande, car l\'adresse ne correspond pas.',
    'Coupon can not apply discount to this order due to customer mismatch.' => 'Le coupon ne peut pas être utilisé pour appliquer une réduction à cette commande, car le client ne correspond pas.',
    'Coupon can not apply discount to this order.' => 'Le coupon ne peut pas être utilisé pour appliquer une réduction à cette commande.',
    ...
    'Craft Commerce - Inventory' => 'Craft Commerce - Inventaire',
    ...
    'Create rules that allow this gateway to match the billing address.' => 'Créez des règles qui permettent à ce portail de faire correspondre l\'adresse de facturation.',
    ...
    'Create rules that allow this gateway to match the shipping address.' => 'Créez des règles qui permettent à ce portail de faire correspondre l\'adresse de livraison.',
    ...
    'Leave gateway subscription as-is' => 'Laisser l\'abonnment au portail tel quel',
    ...
    'Order customer data removed.' => 'Données des commandes de clients supprimées.',
    ...
    'Remove customer association and email from the {numOrders, plural, =1{order} other{orders}}. Optionally select additional customer data to remove below' => 'Retirer l\'association du client et de l\'adresse e-mail {numOrders, plural, =1{de la commande} other{des commandes}}. Vous pouvez également sélectionner d\'autres données de clients à supprimer ci-dessous.',
    ...
    'The customer for this order has been deleted.' => 'Le client pour cette commande a été supprimé.',
    ...
    'The site to be used when this email is rendered.' => 'Le site à utiliser lors de l\'affichage de cet e-mail.',
