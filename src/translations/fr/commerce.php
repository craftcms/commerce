...
return [
    ...
    'Failed updating order status on {num, plural, =1{order}, other{orders}}.' => 'Échec de la mise à jour du statut de la commande de {num, plural, =1{commande}, other{commandes}}.',
    'Feet (ft)' => 'Pieds (ft)',
    ...
    'Only orders with the following order statuses will be included. Leave blank to include all statuses.' => 'Seules les commandes ayant les statuts de commande suivants seront incluses. Laissez vide pour inclure tous les statuts.',
    'Options' => 'Options',
