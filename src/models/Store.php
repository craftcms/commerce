...
class Store extends Model
{
    ...
    {
        return $parse ? (App::parseBooleanEnv($this->_autoSetNewCartAddresses) ?? $this->_autoSetNewCartAddresses) : $this->_autoSetNewCartAddresses;
    }
    ...
    {
        return $parse ? (App::parseBooleanEnv($this->_autoSetCartShippingMethodOption) ?? $this->_autoSetCartShippingMethodOption) : $this->_autoSetCartShippingMethodOption;
    }
    ...
    {
        return $parse ? (App::parseBooleanEnv($this->_autoSetPaymentSource) ?? $this->_autoSetPaymentSource) : $this->_autoSetPaymentSource;
    }
    ...
    {
        return $parse ? (App::parseBooleanEnv($this->_allowEmptyCartOnCheckout) ?? $this->_allowEmptyCartOnCheckout) : $this->_allowEmptyCartOnCheckout;
    }
    ...
    {
        return $parse ? (App::parseBooleanEnv($this->_allowCheckoutWithoutPayment) ?? $this->_allowCheckoutWithoutPayment) : $this->_allowCheckoutWithoutPayment;
    }
    ...
    {
        return $parse ? (App::parseBooleanEnv($this->_allowPartialPaymentOnCheckout) ?? $this->_allowPartialPaymentOnCheckout) : $this->_allowPartialPaymentOnCheckout;
    }
    ...
    {
        return $parse ? (App::parseBooleanEnv($this->_requireShippingAddressAtCheckout) ?? $this->_requireShippingAddressAtCheckout) : $this->_requireShippingAddressAtCheckout;
    }
    ...
    {
        return $parse ? (App::parseBooleanEnv($this->_requireBillingAddressAtCheckout) ?? $this->_requireBillingAddressAtCheckout) : $this->_requireBillingAddressAtCheckout;
    }
    ...
    {
        return $parse ? (App::parseBooleanEnv($this->_requireShippingMethodSelectionAtCheckout) ?? $this->_requireShippingMethodSelectionAtCheckout) : $this->_requireShippingMethodSelectionAtCheckout;
    }
    ...
    {
        return $parse ? (App::parseBooleanEnv($this->_useBillingAddressForTax) ?? $this->_useBillingAddressForTax) : $this->_useBillingAddressForTax;
    }
    ...
    {
        return $parse ? (App::parseBooleanEnv($this->_validateOrganizationTaxIdAsVatId) ?? $this->_validateOrganizationTaxIdAsVatId) : $this->_validateOrganizationTaxIdAsVatId;
    }
