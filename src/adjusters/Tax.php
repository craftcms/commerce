...
class Tax extends Component implements AdjusterInterface
{
    ...
    private function _getAdjustments(TaxRate $taxRate)
    {
        ...
        if ($taxRate->isVat && $vatIdOnAddress && $this->_matchAddress($zone, $taxRate)) {
        ...
        if (!$this->_matchAddress($zone, $taxRate) || $removeVat) {
     ...
     * @return bool
     */
    private function _matchAddress(TaxAddressZone $zone, TaxRate $rate): bool
    {
