...
/**
 * Read-only field exposing {@see User::getPrimaryBillingAddressId()} through the normal
 ...
 */
class PrimaryBillingAddressIdField extends Field
{
    #[\Override]
    public static function displayName(): string
    {
        return t('Primary Billing Address ID', category: 'commerce');
    }
    ...
    public function normalizeValue(mixed $value, ?ElementInterface $element): mixed
    {
        ...
        return $element->getPrimaryBillingAddressId();
    }
