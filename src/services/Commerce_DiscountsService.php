...
class Commerce_DiscountsService extends BaseApplicationComponent
{
	...
	public function saveDiscount(Commerce_DiscountModel $model, array $groups, array $productTypes, array $products)
	{
		...
		$fields = ['id', 'name', 'description', 'dateFrom', 'dateTo', 'enabled', 'purchaseTotal', 'purchaseQty', 'baseDiscount', 'perItemDiscount', 'percentDiscount', 'freeShipping', 'excludeOnSale', 'perUserLimit', 'perEmailLimit', 'totalUseLimit'];
