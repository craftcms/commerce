 ...
 * @since     1.0
 */
class Commerce_SaleService extends BaseApplicationComponent
{
	/**
	 * @param int $id
	 *
	...
	private function getAllByConditions ($productIds, $productTypeIds)
	{
		...
		$groupIds = craft()->commerce_discount->getCurrentUserGroups();
		if ($groupIds)
		{
	...
	)
	{
		...
		$userGroups = craft()->commerce_discount->getCurrentUserGroups();
